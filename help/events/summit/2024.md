...
- **[Esperienze più veloci nella vetrina](https://experienceleague.adobe.com/developer/commerce/storefront/?lang=it):** La nostra nuova architettura, i nostri Edge Delivery Services, la nostra nuova architettura ad alte prestazioni aumentano la velocità del sito, la classificazione SEO e il traffico organico. Inoltre, una nuova integrazione con Adobe Experience Manager Assets semplifica la supply chain dei contenuti con l&#39;accesso allo sviluppo dei contenuti GenAI e alla gestione del flusso di lavoro.
...
Rivivi tutte le sessioni straordinarie **[immergendoti nel contenuto on-demand](https://business.adobe.com/summit/2024/sessions.html?Track=Commerce)** e resta sempre aggiornato sulle ultime innovazioni per Adobe Commerce al [**Experience League**](https://experienceleague.adobe.com/it/docs/commerce-admin/start/about).
