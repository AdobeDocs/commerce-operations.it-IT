...
![Potenziale sperimentale Bots dannosi frame](../../assets/tools/observation-for-adobe-commerce/experimental-potential-malicious-bots-frame-new.jpg)
...
Il **[!UICONTROL Pageview Latency will show as spikes on this graph:]** mostra la latenza di risposta di caricamento pagina/API che potrebbe essere in linea con il [!DNL bot] traffico.
