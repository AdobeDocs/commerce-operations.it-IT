...
La patch ACSD-48866 risolve il problema relativo alla presenza di un errore durante la richiesta di un feed RSS per le categorie. Questa patch è disponibile quando è installato [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.28. L’ID della patch è ACSD-48866. Il problema è pianificato per la risoluzione in Adobe Commerce 2.4.7.
