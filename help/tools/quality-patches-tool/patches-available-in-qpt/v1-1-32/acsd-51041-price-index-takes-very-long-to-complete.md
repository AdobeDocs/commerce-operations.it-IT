...
La patch ACSD-51041 risolve il problema che richiede molto tempo per il completamento dell&#39;indice dei prezzi con un set di prodotti molto grande. Questa patch è disponibile quando è installato [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.32. L’ID della patch è ACSD-51041. Il problema è stato risolto in Adobe Commerce 2.4.6.
