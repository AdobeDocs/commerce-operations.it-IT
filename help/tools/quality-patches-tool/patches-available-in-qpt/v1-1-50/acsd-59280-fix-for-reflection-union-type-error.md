...
La patch ACSD-59280 risolve il problema in cui si verifica l&#39;errore `call to undefined method ReflectionUnionType::getName()` durante l&#39;installazione delle versioni 2.4.4-pX. Questa patch è disponibile quando è installato [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.50. L’ID della patch è ACSD-59280. Il problema è stato risolto in Adobe Commerce 2.4.5.
