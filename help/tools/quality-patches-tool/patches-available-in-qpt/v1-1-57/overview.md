...
1. **ACSD-62708**: è stato risolto il problema che causava la visualizzazione di [!DNL TinyMCE] e non di [!UICONTROL pt] del tipo di carattere dell&#39;editor [!UICONTROL px] 7 dopo l&#39;applicazione della correzione da [!UICONTROL ACP2E-3430]. Ora è anche possibile impostare la dimensione del carattere in [!UICONTROL px] invece di [!UICONTROL pt].
