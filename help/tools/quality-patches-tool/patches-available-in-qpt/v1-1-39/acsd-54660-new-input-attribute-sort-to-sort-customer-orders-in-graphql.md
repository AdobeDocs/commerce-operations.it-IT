...
La patch ACSD-54660 risolve il problema relativo all&#39;aggiunta di un nuovo attributo di input `sort` per ordinare gli ordini cliente in [!DNL GraphQL] da parte di `sort_field` e `sort_direction`. Questa patch è disponibile quando è installato [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.39. L’ID della patch è ACSD-54660. Il problema è pianificato per essere risolto in Adobe Commerce 2.4.6.
