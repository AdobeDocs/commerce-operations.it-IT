...
La patch ACSD-56158 risolve il problema in cui il rendering del valore dell’imposta nella risposta di GraphQL non è corretto quando al carrello vengono applicate più regole fiscali. Questa patch è disponibile quando è installato [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.44. L’ID della patch è ACSD-56158. Il problema è pianificato per la risoluzione in Adobe Commerce 2.4.7.
