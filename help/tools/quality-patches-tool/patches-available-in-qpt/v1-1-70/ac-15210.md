...
Dopo l’applicazione della patch, aggiorna la configurazione del corriere marittimo Commerce USPS per integrarla con le nuove API USPS. Per istruzioni, vedere l&#39;argomento [Strumenti Web USPS obsoleti](https://experienceleague.adobe.com/it/docs/commerce-admin/stores-sales/delivery/shipping-carriers/carriers#usps-web-tools-api-deprecation) nella *Guida agli acquisti e ai negozi*.
