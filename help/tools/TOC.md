...
- Strumento Patch di qualità {#quality-patches-tool}
   ...
   - Patch disponibili nello strumento Patch di qualità {#patches-available-in-qpt}
      ...
      - v1.1.2 {#v1-1-2}
         - [Panoramica: Quality Patches Tool (QPT) v1.1.2](quality-patches-tool/patches-available-in-qpt/v1-1-2/overview.md)
         - [MDVA-37115: l&#39;avviso &quot;Disponibile solo 0&quot; viene visualizzato sulla pagina del prodotto](quality-patches-tool/patches-available-in-qpt/v1-1-2/mdva-37115-unnecessary-only-0-left-notice-is-shown-on-the-configurable-product-page.md)
         - [MDVA-37364: L&#39;attributo cliente personalizzato del tipo data interrompe la interfaccia griglia](quality-patches-tool/patches-available-in-qpt/v1-1-2/mdva-37364-custom-customer-attribute-of-date-type-breaks-the-customer-grid-ui.md)
         - [MDVA-38447: I prodotti secondari configurabili &quot;Non visibili singolarmente&quot; vengono restituiti nella risposta GraphQL e nella query MySQL lenta](quality-patches-tool/patches-available-in-qpt/v1-1-2/mdva-38447-not-visible-individually-configurable-child-products.md)
         ...
         - [MDVA-39043: Gli utenti amministratori ricevono un errore durante l&#39;aggiunta del widget alla pagina CMS](quality-patches-tool/patches-available-in-qpt/v1-1-2/mdva-39043-admin-users-with-limited-access-get-error-while-adding-products-widget-to-cms.md)
         - [MDVA-39195: Aggiungi al carrello è inattivo nel Categoria Pagina](quality-patches-tool/patches-available-in-qpt/v1-1-2/mdva-39195-add-to-cart-button-is-inactive-on-the-category-page.md)
         ...
         - [MDVA-39521: Impossibile impostare l&#39;indirizzo di spedizione sui carrelli tramite GraphQL](quality-patches-tool/patches-available-in-qpt/v1-1-2/mdva-39521-unable-to-set-shipping-address-on-cart-via-graphql.md)
      ...
      - v1.1.6 {#v1-1-6}
         ...
         - [MDVA-40550: Prodotti mancanti sul frontend dopo la reindicizzazione](quality-patches-tool/patches-available-in-qpt/v1-1-6/mdva-40550-products-missing-on-the-frontend-after-reindexing.md)
      ...
      - v1.1.7 {#v1-1-7}
         - [Panoramica: Quality Patches Tool (QPT) v1.1.7](quality-patches-tool/patches-available-in-qpt/v1-1-7/overview.md)
      ...
      - v1.1.12 {#v1-1-12}
         ...
         - [MDVA-41628: Gli utenti amministratori con restrizioni possono accesso alle nuove risorse](quality-patches-tool/patches-available-in-qpt/v1-1-12/mdva-41628-restricted-admin-user-gets-access-to-new-resources.md)
         - [MDVA-42410: I report delle cedole visualizzano solo la valuta di base predefinita](quality-patches-tool/patches-available-in-qpt/v1-1-12/mdva-42410-coupon-reports-only-display-default-base-currency.md)
         ...
         - [MDVA-43232: L&#39;ordinamento dei prodotti nel visual merchandiser per prezzo speciale in alto (o in basso) causa un errore](quality-patches-tool/patches-available-in-qpt/v1-1-12/mdva-43232-sorting-products-in-visual-merchandiser-by-special-price-to-bottom-top-causes-error.md)
         - [MDVA-43348: Il richiesta GraphQL della carta regalo mostra un errore](quality-patches-tool/patches-available-in-qpt/v1-1-12/mdva-43348-gift-card-graphql-request-shows-error.md)
         - [MDVA-43414: Errore irreversibile PHP durante l&#39;esecuzione di &quot;inventory.reservations.updateSalabilityStatus&quot;](quality-patches-tool/patches-available-in-qpt/v1-1-12/mdva-43414-php-fatal-error-when-running-the-inventory-reservations-update-salability-status.md)
      ...
      - v1.1.17 {#v1-1-17}
         ...
         - [ACSD-45143: la mutazione setShippingAddressesOnCart non imposta il codice numerico area geografica come &#39;area geografica&#39;](quality-patches-tool/patches-available-in-qpt/v1-1-17/acsd-45143-setshippingaddressoncart-mutation-doesnt-allow-setting-numeric-region-code.md)
         - [ACSD-45169: Visual Merchandiser visualizza stock e prezzo errati per il prodotto configurabile](quality-patches-tool/patches-available-in-qpt/v1-1-17/acsd-45169-visual-merchandiser-does-not-display-correct-stock.md)
         - [ACSD-45241: lo stock del prodotto virtuale quantità calcolato in modo errato](quality-patches-tool/patches-available-in-qpt/v1-1-17/acsd-45241-stock-quantity-for-virtual-product-miscalculated.md)
         - [ACSD-45424: Compensazione errata della prenotazione creata dopo un rimborso parziale](quality-patches-tool/patches-available-in-qpt/v1-1-17/acsd-45424-incorrect-reservation-compensation-created-after-partial-refund.md)
      ...
      - v1.1.18 {#v1-1-18}
         ...
         - [ACSD-45488: prodotto configurabile con più fonti non restituito automaticamente a magazzino](quality-patches-tool/patches-available-in-qpt/v1-1-18/acsd-45488-configurable-product-with-multiple-sources-not-returned-to-in-stock.md)
         ...
         - [ACSD-45817: la mutazione dei prodotti GraphQL fornisce tutte le varianti configurabili](quality-patches-tool/patches-available-in-qpt/v1-1-18/acsd-45817-graphql-products-mutation-gives-all-configurable-variants.md)
         - [ACSD-45849: Video metadati viene perso dopo l&#39;aggiornamento di staging](quality-patches-tool/patches-available-in-qpt/v1-1-18/acsd-45849-video-metadata-lost-after-staging-update.md)
      ...
      - v1.1.24 {#v1-1-24}
         ...
         - [ACSD-47955: GraphQL non visualizza correttamente lo sconto del carrello](quality-patches-tool/patches-available-in-qpt/v1-1-24/acsd-47955-graphql-does-not-display-cart-discount-correctly.md)
         - [ACSD-47920: i utente ospiti possono effettuare ordini tramite API REST lineare quando [!UICONTROL Allow Guest Checkout] è disattivato](quality-patches-tool/patches-available-in-qpt/v1-1-24/acsd-47920-guest-order-allow-guest-checkout-off.md)
         - [ACSD-47004: IVA non applicata a fatturazione indirizzo senza partita IVA](quality-patches-tool/patches-available-in-qpt/v1-1-24/acsd-47004-vat-not-applied-to-billing-address-without-vat-id.md)
         - [ACSD-46770: L&#39;e-mail di conferma dell&#39;ordine viene inviata lineare quando [!UICONTROL Email order confirmation] non è selezionata](quality-patches-tool/patches-available-in-qpt/v1-1-24/acsd-46770-order-confirmation-email-without-confirmation.md)
      ...
      - v1.1.25 {#v1-1-25}
         ...
         - [ACSD-48044: l&#39;applicazione di più buoni regalo impedisce l&#39;esecuzione di ordini](quality-patches-tool/patches-available-in-qpt/v1-1-25/acsd-48044-applying-multiple-gift-cards-prevents-orders.md)
      ...
      - v1.1.26 {#v1-1-26}
         ...
         - [ACSD-47988: esportazione del prodotto taglia i tag HTML dalla descrizione del prodotto di page builder](quality-patches-tool/patches-available-in-qpt/v1-1-26/acsd-47988-product-export-trims-html-tags.md)
      ...
      - v1.1.28 {#v1-1-28}
         ...
         - [ACSD-49286: Prodotto aggiunto due volte al carrello quando sono presenti più widget del prodotto](quality-patches-tool/patches-available-in-qpt/v1-1-28/acsd-49286-product-added-twice-to-cart-when-multiple-product-widgets-are-present-on-page.md)
         - [ACSD-48204: Il prezzo di catalogo regola creato in base all&#39;attributo Sì o No non considera le ambito selezionate](quality-patches-tool/patches-available-in-qpt/v1-1-28/acsd-48204-catalog-price-rule-created-based-on-yes-no-attribute.md)
      ...
      - v1.1.29 {#v1-1-29}
         ...
         - [ACSD-49389: Pronto per il ritiro e-mail inviato dall&#39;API quando non pronto per il ritiro](quality-patches-tool/patches-available-in-qpt/v1-1-29/acsd-49389-ready-pickup-email-sent-api.md)
         ...
         - [ACSD-49960: Il filtro per data non funziona per la griglia degli ordini del cliente](quality-patches-tool/patches-available-in-qpt/v1-1-29/acsd-49960-filtering-by-date-does-not-work-for-customer-order-grid.md)
         - [ACSD-49822: aggiornamenti sull&#39;elenco delle richieste non riflessi nell&#39;elenco delle richieste di stampa](quality-patches-tool/patches-available-in-qpt/v1-1-29/acsd-49822-updates-on-requisition-list-page-not-reflected-on-print.md)
         - [ACSD-49835: [!UICONTROL Use Default Value] casella di controllo non salvata](quality-patches-tool/patches-available-in-qpt/v1-1-29/acsd-49835-use-default-value-chekbox-not-saved.md)
         ...
         - [ACSD-49502: Scaricabile collegare non aggiornato correttamente dopo [!DNL staging] l&#39;aggiornamento](quality-patches-tool/patches-available-in-qpt/v1-1-29/acsd-49502-downloadable-link-not-updated-correctly.md)
         ...
         - [ACSD-50260: i risultati ricerca del prodotto GraphQL sono limitati](quality-patches-tool/patches-available-in-qpt/v1-1-29/acsd-50260-graphql-product-search-results-are-limited.md)
         - [ACSD-49898: La griglia dei prodotti genera un&#39;eccezione](quality-patches-tool/patches-available-in-qpt/v1-1-29/acsd-49898-products-grid-throws-exception-when-special-price-of-bundled-product-exceeds-1000.md)
         - [ACSD-50234: Nome cliente errato nell&#39;e-mail di conferma per gli ordini effettuati tramite [!DNL PayPal]](quality-patches-tool/patches-available-in-qpt/v1-1-29/acsd-50234-incorrect-customer-name-in-confirmation-email-for-orders-placed-with-paypal.md)
         - [ACSD-48813: Search non mostra risultati rilevanti in base ricerca peso degli attributi](quality-patches-tool/patches-available-in-qpt/v1-1-29/acsd-48813-search-not-showing-relevant-results-based-on-search-weight-of-attributes.md)
      ...
      - v1.1.32 {#v1-1-32}
         ...
         - [ACSD-51291: l&#39;amministratore con restrizioni può aggiungere immagini/video al prodotto assegnato a più siti Web](quality-patches-tool/patches-available-in-qpt/v1-1-32/acsd-51291-restricted-admin-can-add-images-videos-to-product-assigned-to-multiple-websites.md)
      ...
      - v1.1.33 {#v1-1-33}
         ...
         - [ACSD-51240: File caricato mancante durante la registrazione tramite il modulo registrazione aziendale](quality-patches-tool/patches-available-in-qpt/v1-1-33/acsd-51240-uploaded-file-missing-while-registering-via-company-registration-form.md)
         - [ACSD-51907: I utente di amministrazione con restrizioni non possono creare note di credito per il rimborso offline](quality-patches-tool/patches-available-in-qpt/v1-1-33/acsd-51907-restricted-admin-user-cannot-create-a-credit-memo-with-an-offline-refund.md)
         - [ACSD-51892: Problema di prestazioni per cui i file di configurazione vengono caricati più volte](quality-patches-tool/patches-available-in-qpt/v1-1-33/acsd-51892-performance-issue-where-config-files-load-multiple-times.md)
         - [ACSD-50478: Problema JS per l&#39;azione di rollback nella griglia di backup e nel comando di rollback del database](quality-patches-tool/patches-available-in-qpt/v1-1-33/acsd-50478-database-rollback-command-when-db-dump-contains-triggers.md)
         ...
         - [ACSD-50895: i tag GTM Google Analytics 3 non vengono attivati se Google Analytics 4 GTM non è configurato](quality-patches-tool/patches-available-in-qpt/v1-1-33/acsd-50895-google-analytics-3-gtm-tags-are-not-fired-if-google-analytics-4-gtm-is-not-configured.md)
         ...
         - [ACSD-51120: La cache delle richieste di GET GraphQL non è stata cancellata per le pagine CMS che contengono blocchi CMS](quality-patches-tool/patches-available-in-qpt/v1-1-33/acsd-51120-graphql-get-requests-cache-not-cleared-for-cms-pages.md)
      ...
      - v1.1.36{#v1-1-36}
         ...
         - [ACSD-51666: Errore &quot;La sessione è scaduta, per favore login di nuovo.&quot; dopo l’accesso](quality-patches-tool/patches-available-in-qpt/v1-1-36/acsd-51666-error-session-has-expired-please-login-again.md)
         - [ACSD-52906: Risoluzione del problema relativo ai cookie X-Magento-Vary per gli caching clienti connessi](quality-patches-tool/patches-available-in-qpt/v1-1-36/acsd-52906-resolving-x-magento-vary-cookie-issue-logged-in-customer-caching.md)
      - v1.1.37 {#v1-1-37}
      ...
      - v1.1.42 {#v1-1-42}
         ...
         - [ACSD-55381: Risoluzione di un errore durante la richiesta di UID di opzioni di prodotto configurabili da B2B elenco di richieste](quality-patches-tool/patches-available-in-qpt/v1-1-42/acsd-55381-resolving-internal-server-error-in-b2b-graphql-queries.md)
         ...
         - [ACSD-54890: aggregato_sales_report_bestsellers_data causa [!DNL MySQL] errori](quality-patches-tool/patches-available-in-qpt/v1-1-42/acsd-54890-aggregate-sales-report-bestsellers-data-causes-mysql-errors.md)
         - [ACSD-48910: il prodotto in bundle assegnato a più fonti va esaurito dopo la fatturazione e la spedizione](quality-patches-tool/patches-available-in-qpt/v1-1-42/acsd-48910-bundle-product-assigned-to-multiple-sources-out-of-stock.md)
      - v1.1.43 {#v1-1-43}
         - [Panoramica: [!DNL Quality Patches Tool] (QPT) v1.1.43](quality-patches-tool/patches-available-in-qpt/v1-1-43/overview.md)
         - [ACSD-52714: Il filtro della data non funziona nella griglia di amministrazione quando è impostato come y-m-d](quality-patches-tool/patches-available-in-qpt/v1-1-43/acsd-52714-date-filter-does-not-work-in-admin-grid-when-set-as-y-m-d.md)
         - [ACSD-56090: La risposta GraphQL non è store specifica](quality-patches-tool/patches-available-in-qpt/v1-1-43/acsd-56090-graphql-request-responds-all-stores-data-and-not-requested-store-data.md)
         - [ACSD-55610: l&#39;ordine parzialmente annullato ha un importo di sconto errato](quality-patches-tool/patches-available-in-qpt/v1-1-43/acsd-55610-partially-canceled-order-has-incorrect-discount-amount.md)
         - [ACSD-55334: Etichette non tradotte tramite dizionari di traduzione nella risposta GraphQL](quality-patches-tool/patches-available-in-qpt/v1-1-43/acsd-55334-labels-not-translated-through-translation-dictionaries.md)
         - [ACSD-55305: Blocco del popup durante la modifica del utente aziendale in [!UICONTROL My Account]](quality-patches-tool/patches-available-in-qpt/v1-1-43/acsd-55305-freeze-issue-in-company-user-edit-popup.md)
      ...
      - v1.1.44 {#v1-1-44}
         ...
         - [ACSD-56280: Gli acquisti nel registro dei regali non vengono completati](quality-patches-tool/patches-available-in-qpt/v1-1-44/acsd-56280-gift-registry-purchases-are-not-completed.md)
         - [ACSD-56193: [!DNL Fastly/Varnish] cache non cancellata per contenuto aggiornamento di staging](quality-patches-tool/patches-available-in-qpt/v1-1-44/acsd-56193-fastly-cache-not-cleared-for-content-staging-update.md)
         - [ACSD-56158: Valore fiscale errato nella risposta GraphQL quando più regole fiscali applicate al carrello](quality-patches-tool/patches-available-in-qpt/v1-1-44/acsd-56158-wrong-tax-value-in-graphql-when-multiple-tax-rules-applied-to-cart.md)
      ...
      - v1.1.48 {#v1-1-48}
         ...
         - [ACSD-57854: la risposta GraphQL contiene categorie disabilitate che non devono essere elencate nelle aggregazioni di categorie](quality-patches-tool/patches-available-in-qpt/v1-1-48/acsd-57854-graphql-response-contains-disabled-categories.md)
         - [ACSD-57565: Il dashboard degli ordini visualizza informazioni sull&#39;ordine errate](quality-patches-tool/patches-available-in-qpt/v1-1-48/acsd-57565-the-order-dashboard-displays-incorrect-order-information.md)
      - v1.1.49 {#v1-1-49}
         - [Panoramica: [!DNL Quality Patches Tool] (QPT) v1.1.49](quality-patches-tool/patches-available-in-qpt/v1-1-49/overview.md)
         - [ACSD-57643: I prodotti con opzioni personalizzate vengono aggiunti in modo errato](quality-patches-tool/patches-available-in-qpt/v1-1-49/acsd-57643-products-with-custom-options-are-incorrectly-added.md)
         - [ACSD-57588: Errore nell&#39;elaborazione dell&#39;ID area geografica durante la spedizione a più indirizzi](quality-patches-tool/patches-available-in-qpt/v1-1-49/acsd-57588-region-id-error-when-shipping-to-multiple-addresses.md)
         - [ACSD-56979: immagini dei prodotti rimosse dopo l&#39;eliminazione dell&#39;aggiornamento di staging](quality-patches-tool/patches-available-in-qpt/v1-1-49/acsd-56979-product-images-removed-after-staging-update-deleted.md)
         - [ACSD-58163: [!UICONTROL Cart Price Rule] non applica lo sconto dal carrello corrispondente [!UICONTROL Customer Segment] senza codice coupon](quality-patches-tool/patches-available-in-qpt/v1-1-49/acsd-58163-cart-price-rule-does-not-apply-discount-from-matching-customer-segment.md)
      ...
      - v1.1.50 {#v1-1-50}
         ...
         - [ACSD-60303: problema di posizionamento dell’ordine amministratore risolto con la minimizzazione dei HTML abilitata](quality-patches-tool/patches-available-in-qpt/v1-1-50/acsd-60303-admin-order-placement-fix.md)
      - v1.1.51 {#v1-1-51}
...
- Osservazione per il commercio Adobe Systems {#observation-for-adobe-commerce}
   ...
   - [Come accesso](observation-for-adobe-commerce/access.md)
   - [Selezione delle account e delle arco temporale](observation-for-adobe-commerce/selecting-the-account.md)
   - [Scelta delle schede concentrarsi](observation-for-adobe-commerce/choosing-focus-tabs.md)
   - [Il riepilogo scheda](observation-for-adobe-commerce/summary.md)
