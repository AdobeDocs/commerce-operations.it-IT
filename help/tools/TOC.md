...
- Automazione dell&#39;applicazione di patch {#caps-tool}
  - {hide-from-toc}[Introduzione](caps-tool/intro.md)
  - {hide-from-toc}[Accesso](caps-tool/access.md)
  - {hide-from-toc}[Panoramica del flusso di lavoro](caps-tool/workflow.md)
  - {hide-from-toc}[Integrazione GitHub](caps-tool/github-integration.md)
...
- Strumento Patch di qualità {#quality-patches-tool}
  ...
  - Patch disponibili nello strumento Patch di qualità {#patches-available-in-qpt}
    ...
    - v1.1.22 {#v1-1-22}
      ...
      - [ACSD-47332: errore Cron segnalato solo quando si esegue tra le 00:00 e le 00:59 UTC](quality-patches-tool/patches-available-in-qpt/v1-1-22/acsd-47332-cron-fails-with-error-reported-between-00-59.md)
    - v1.1.23 {#v1-1-23}
    ...
    - v1.1.30 {#v1-1-30}
      ...
      - [B2B-2598: aggiunge la funzionalità di caching per storeConfig, currency, country, countries, availableStores GraphQl query](quality-patches-tool/patches-available-in-qpt/v1-1-30/b2b-2598-add-caching-capability.md)
    ...
    - v1.1.50 {#v1-1-50}
      ...
      - [ACSD-46938: problemi di prestazioni con i trigger del database durante l&#39;installazione:upgrade](quality-patches-tool/patches-available-in-qpt/v1-1-50/acsd-46938-fix-for-db-triggers-performance-issue-during-setup-upgrade.md)
    ...
    - v1.1.55 {#v1-1-55}
      ...
      - [ACSD-61534: impossibile impostare la configurazione di progettazione con la configurazione bin/magento:set](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-55/acsd-61534-design-configuration-cannot-set-using-bin-magento-config-set.md)
    ...
    - v1.1.72 {#v1-1-72}
      ...
      - [ACSD-68011: SKU non esistenti assegnati al catalogo condiviso tramite /V1/sharedCatalog/:id/assignProducts API](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/acsd-68011.md)
    ...
    - v1.1.75 {#v1-1-75}
      ...
      - [ACSD-68359: Correzioni dell&#39;errore 414 durante la selezione di [!UICONTROL Pick in Store] con carrelli di grandi dimensioni](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/acsd-68359.md)
      - [ACSD-68517: è stato corretto un errore di reinvio modulo su [!UICONTROL Catalog] e [!UICONTROL Catalog Search] pagine](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/acsd-68517.md)
    ...
    - v1.1.76 {#v1-1-76}
      ...
      - [ACSD-69319: i prezzi dei prodotti bundle non venivano indicizzati correttamente quando i prodotti secondari avevano scorte in origini personalizzate](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69319.md)
      - [ACSD-69086: installazione non riuscita su MariaDB 10.11 a causa di un controllo della versione del database non supportato](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69086.md)
      - [ACSD-69331: la creazione della cartella di Media Gallery non riesce per gli utenti amministratori che dispongono solo dell’autorizzazione Crea cartella](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69331.md)
      - [ACSD-69203: il widget Elenco prodotti restituisce risultati errati quando vengono utilizzate più categorie nella condizione di categoria](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69203.md)
      - [ACSD-69115: gli errori del carrello non vengono visualizzati agli utenti amministratori per i clienti assegnati a siti web non predefiniti](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69115.md)
      - [ACSD-67370: sono stati visualizzati prezzi errati per i prodotti Bundle su PDP/PLP e la pagina del carrello per i negozi multi-valuta](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-67370.md)
      - [ACSD-69261: coupon per regola prezzo carrello monouso riutilizzato a causa di gestione time_used errata in flussi parziali di fatture e annullamenti](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69261.md)
      - [ACSD-67091: la pulizia dell’indice del prodotto della regola del catalogo non riesce a causa della dimensione massima del set di scrittura durante le eliminazioni di grandi dimensioni](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-67091.md)
      - [ACSD-69308: le regole del prezzo di catalogo non si applicano quando &quot;special_price&quot; è impostato a livello di sito web](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69308.md)
      - [ACSD-69541: ACSD-69541: la quantità dell&#39;articolo del carrello non può essere aggiornata tramite GraphQL dopo la riduzione delle scorte di prodotto in [!UICONTROL Admin]](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69541.md)
      - [ACSD-69325: la modifica della custodia SKU ha causato la mancata disponibilità del prodotto nella vetrina](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69325.md)
      - [ACSD-69129: [!DNL REST] L&#39;aggiornamento del prezzo del livello API non riesce dopo l&#39;eliminazione del sito Web di base predefinito e l&#39;utilizzo del sito Web secondario come predefinito](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69129.md)
      - [ACSD-68410: il pagamento delle offerte negoziabili include gli articoli non desiderati del carrello](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-68410.md)
      - [ACSD-69333: modifiche SKU consentite per i prodotti con un aggiornamento pianificato attivo](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69333.md)
    - v1.1.77 {#v1-1-77}
      - [Panoramica: [!DNL Quality Patches Tool] (QPT) v1.1.77](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/overview.md)
      - [ACSD-69237: sales_*_async_insert cron jobs elabora solo 100 voci per esecuzione](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-69237.md)
      - [ACSD-68759: la creazione dell&#39;account cliente non riesce con la lingua araba (Arabia Saudita) quando [!UICONTROL Date of Birth] è visibile nella vetrina](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-68759.md)
      - [ACSD-69016: il prezzo speciale non viene applicato su siti web con fusi orari diversi](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-69016.md)
      - [ACSD-69351: i saldi delle gift card e le date di scadenza vengono visualizzati su siti Web errati](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-69351.md)
      - [ACSD-69020: i prodotti configurabili vengono visualizzati nei caroselli  [!DNL Page Builder]  quando i prodotti secondari corrispondono ai filtri](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-69020.md)
      - [ACSD-68892: comportamento di caching  [!DNL Fastly]  incoerente per le pagine memorizzabili in cache](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-68892.md)
      - [ACSD-68664: l’anteprima dell’aggiornamento pianificato presenta errori nei domini store personalizzati](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-68664.md)
      - [ACSD-63687: vengono visualizzati prezzi errati a causa di  [!DNL Redis]  problemi di pulizia della cache](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-63687.md)
      - [ACSD-69494: le richieste di rimborso asincrone con &quot;is_online&quot; non attivano i rimborsi online](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-69494.md)
      - [ACSD-68537: le prestazioni di checkout peggiorano con molti segmenti di clienti](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-68537.md)
      - [ACSD-69311: calcolo fiscale errato nelle note di accredito dopo rimborsi parziali dalle fatture](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-69311.md)
      - [ACSD-68341: al caricamento della PDP si verificano più aggiornamenti dei cookie X-Magento-Vary](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-68341.md)
    - v1.1.78 {#v1-1-78}
      - [Panoramica: [!DNL Quality Patches Tool] (QPT) v1.1.78](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/overview.md)
      - [ACP2E-4513: le immagini CAPTCHA scadute non vengono rimosse dal sistema](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4513.md)
      - [ACP2E-4528: la convalida della città dell’indirizzo del cliente gestisce in modo errato le barre (/) e caratteri non validi come !, &quot;, # e ?](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4528.md)
      - [ACP2E-4628: l’importazione di clienti con indirizzi e-mail in maiuscolo innesca un errore di chiave di array non definito quando Condivisione account è impostato su Globale](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4628.md)
      - [ACSD-60989: la modifica di una colonna con una chiave esterna tramite uno schema dichiarativo causa errori in  [!DNL MariaDB]](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acsd-60989.md)
      - [ACP2E-4763: la query customerOrders di GraphQL restituisce valori gonfiati original_price_included_tax e original_row_total_included_tax](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4763.md)
      - [ACP2E-4591: i segmenti del cliente basati sul conteggio degli ordini, ad esempio &quot;Acquirenti nuovi&quot;, non vengono aggiornati quando gli ordini vengono effettuati tramite l’API REST](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4591.md)
      - [ACP2E-4732: l&#39;indicizzazione parziale viene interrotta per i clienti con molti aggiornamenti quando la colonna version_id nella tabella changelog raggiunge il valore massimo](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4732.md)
      - [ACP2E-4456: l’annullamento di un ordine con una mutazione GraphQL non sposta in stato Chiuso gli ordini pagati interamente con gift card](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4456.md)
      - [ACP2E-4452: i prezzi dei prodotti della pagina Ordine rapido includono le imposte indipendentemente dalla configurazione della visualizzazione delle imposte](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4452.md)
      - [ACP2E-4448: le modifiche alla configurazione apportate durante [!DNL Redis] interruzioni non vengono applicate dopo [!DNL Redis] ripristini e i valori non aggiornati persistono](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4448.md)
      - [ACP2E-4665: i prodotti secondari di prodotti configurabili con video nelle gallerie di prodotti non vengono visualizzati quando richiesto tramite l’API REST](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4665.md)
      - [ACP2E-4613: una directory multimediale di grandi dimensioni causa ritardi nel caricamento della struttura di directory di Media Gallery](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4613.md)
      - [ACP2E-4609: la pagina [!UICONTROL My Quotes] non mostra virgolette quando alcune virgolette contengono prodotti eliminati](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4609.md)
      - [ACP2E-4416: i punti premio del cliente non vengono inizializzati quando vengono creati in Admin](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4416.md)
      - [ACP2E-4535: l’invio del modulo per password dimenticata distrugge o rigenera la sessione (modifiche PHPSESSID) e cancella il carrello degli ospiti](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4535.md)
      - [ACP2E-4507: la configurazione di [!UICONTROL Password Options] non è applicabile alle richieste di reimpostazione della password del cliente effettuate tramite mutazioni GraphQL](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4507.md)
      - [ACP2E-4431: [!UICONTROL Related Products] corrispondenti alle regole di destinazione vengono eliminati durante il processo di reindicizzazione](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4431.md)
      - [ACP2E-4540: la libreria Fotorama non viene caricata correttamente, pertanto è visibile solo la prima immagine allegata](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4540.md)
      - [ACP2E-4555: i numeri di telefono che contengono periodi o barre non vengono convalidati correttamente](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4555.md)
      - [ACP2E-4565: la query GraphQL della società restituisce &quot;Il cliente corrente non è autorizzato&quot; quando viene utilizzata l’intestazione X-Adobe-Company](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4565.md)
      - [ACP2E-4522: errori chiave duplicati intermittenti si verificano nella tabella quote_coupons quando più richieste di unione carrello o di salvataggio preventivo vengono eseguite contemporaneamente](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4522.md)
    ...
    - v1.1.79 {#v1-1-79}
      ...
      - [ACP2E-4706: il cron dell’indicizzatore della regola di destinazione non sceglie i prodotti abilitati solo nell’ambito della visualizzazione archivio](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-79/acp2e-4706.md)
      - [ACP2E-4402: l’indicizzatore incrementale della regola di destinazione non sceglie i prodotti disabilitati](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-79/acp2e-4402.md)
      - [ACP2E-4505: dipendenza circolare tra categorie dal salvataggio di una categoria con dati non aggiornati in una scheda del browser duplicata](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-79/acp2e-4505.md)
      - [ACP2E-4531: la gerarchia di CMS non aggiorna l’URL gerarchico quando cambia la chiave dell’URL della pagina figlio](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-79/acp2e-4531.md)
      - [ACP2E-4720: le regole di prezzo del carrello di spedizione gratuito non vengono reimpostate per i prodotti in bundle a prezzo fisso con articoli di spedizione separati](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-79/acp2e-4720.md)
    ...
    - v1.1.80 {#v1-1-80}
      ...
      - [ACP2E-4610: esecuzione lenta di `sales_clean_quotes` cron](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4610.md)
      - [ACP2E-4626: il caricamento dei file JavaScript Storefront due volte causa caricamenti duplicati e un comportamento instabile](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4626.md)
      - [ACP2E-4552: la risposta di GraphQL non restituisce lo stato dell&#39;azienda](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4552.md)
      - [ACP2E-4496: il processo cron di Analytics riduce le prestazioni durante l’esecuzione](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4496.md)
      - [ACP2E-4488: salvataggio/modifica lento del prodotto Admin per set di attributi di grandi dimensioni](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4488.md)
    ...
    - v1.1.81 {#v1-1-81}
      ...
      - [ACP2E-4395: i prodotti gift card possono essere creati tramite API senza un importo in ambito globale](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-81/acp2e-4395.md)
      - [ACP2E-4401: [!UICONTROL Scheduled Update Preview] di [!UICONTROL Home Page] con prodotti configurabili reindirizzati a [!UICONTROL maintenance page]](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-81/acp2e-4401.md)
      - [ACP2E-4468: gli utenti amministratori con ambito sito web non possono salvare blocchi dinamici in Page Builder](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-81/acp2e-4468.md)
    ...
    - v1.1.82 {#v1-1-82}
      ...
      - [ACP2E-4840: la query prodotti GraphQL restituisce quantità null per i prodotti in magazzino nelle scorte di magazzino personalizzate](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-82/acp2e-4840.md)
      - [ACP2E-4695: errori di memoria esaurita nell’indicizzatore della regola del catalogo causati da un utilizzo eccessivo della memoria](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-82/acp2e-4695.md)
      - [ACP2E-4194: le richieste GraphQL con nomi di filtro sconosciuti causano i registri eccezioni PHP](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-82/acp2e-4194.md)
...
- Strumento di migrazione dati {#data-migration}
  ...
  - Risorse {#resources}
    - [Risoluzione dei problemi](https://experienceleague.adobe.com/it/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/data-migration-tool-troubleshooting)
