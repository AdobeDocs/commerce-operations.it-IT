...
- **[[!DNL Managed Alerts]](/help/tools/managed-alerts-for-adobe-commerce/managed-alerts-for-magento-commerce.md)** - Monitora le metriche chiave (CPU, prestazioni delle applicazioni, stato del disco, della memoria e del database) e fornisce chiari passaggi per la risoluzione dei problemi in modo da aiutare i commercianti a stare al passo con i problemi ed evitare tempi di inattività.
