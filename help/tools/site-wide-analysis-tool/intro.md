...
Include anche un grafico cronologico per monitorare come cambia lo stato di salute del sito web nel tempo.
   - Mostra **[!UICONTROL Security Center Widget]** che fornisce collegamenti alle risorse seguenti:
      - [Conformità Tech [!DNL Stack] versione con [!DNL end of life (EOL)]](https://experienceleague.adobe.com/en/docs/commerce-operations/installation-guide/system-requirements)
      ...
      - [[!DNL Site-Wide Analysis Tool] raccomandazioni per la sicurezza delle best practice](https://experienceleague.adobe.com/en/docs/commerce-operations/tools/site-wide-analysis-tool/recommendations)
...
- **[[!DNL Managed Alerts]](https://experienceleague.adobe.com/en/docs/commerce-operations/tools/managed-alerts-for-adobe-commerce/managed-alerts-for-magento-commerce)** - Monitora le metriche chiave (CPU, prestazioni dell&#39;applicazione, stato del disco, della memoria e del database) e fornisce chiari passaggi per la risoluzione dei problemi per aiutare i commercianti a stare al passo con i problemi ed evitare tempi di inattività.
