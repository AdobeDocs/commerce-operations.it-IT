...
1. [Connessione al database del sito](https://experienceleague.adobe.com/it/docs/commerce-on-cloud/user-guide/configure/service/mysql#connect-to-the-database).
