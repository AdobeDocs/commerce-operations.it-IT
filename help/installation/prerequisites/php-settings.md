...
>[!NOTE]
>
>La versione più recente di Adobe Commerce richiede almeno PHP 8.1. Consulta [requisiti di sistema](../system-requirements.md) per tutte le versioni supportate di PHP.
