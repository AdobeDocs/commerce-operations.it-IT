...
Nell&#39;output del comando, la riga `Server version` indica la versione in esecuzione. Conferma che corrisponda a una versione supportata per la versione di Adobe Commerce che stai installando.
