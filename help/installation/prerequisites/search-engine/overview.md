...
A partire da Adobe Commerce e dal Magento Open Source 2.4, tutte le installazioni devono essere configurate per utilizzare [Elasticsearch](https://www.elastic.co) o [OpenSearch](https://opensearch.org/) come [catalogo](https://glossary.magento.com/catalog) soluzione di ricerca
