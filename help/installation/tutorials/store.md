...
description: Scopri come configurare l’archivio Adobe Commerce dalla riga di comando dopo la configurazione della distribuzione e la configurazione dello schema del database, incluse le opzioni di installazione sicura.
...
| `--language` | Codice lingua da utilizzare nell&#39;Admin e nella vetrina.<br><br>(Se non lo hai già fatto, puoi visualizzare l&#39;elenco dei codici lingua immettendo `magento info:language:list` dalla directory `bin`). | No |
...
| `--admin-use-security-key` | `1` fa in modo che l&#39;applicazione utilizzi un valore chiave generato in modo casuale per accedere alle pagine in Amministrazione e nei moduli. Questi valori chiave aiutano a prevenire attacchi di tipo cross-site script forgery. Impostazione predefinita.<br/><br/>`0` disabilita l&#39;utilizzo della chiave. | No |
