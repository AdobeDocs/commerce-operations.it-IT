...
description: Scopri la soluzione di prestazioni del database suddiviso per Adobe Commerce, che consente di distinguere checkout, ordini e schemi di prodotto per la scalabilità locale.
