...
A partire dalla versione 2.4.4, Adobe Commerce richiede [Elasticsearch](https://www.elastic.co) o [OpenSearch](https://opensearch.org/docs/latest/opensearch/install/index/) come motore di ricerca del catalogo. Le versioni precedenti di 2.4.x richiedevano Elasticsearch. Per informazioni dettagliate sull’installazione di un motore di ricerca e sulla configurazione iniziale, consulta i seguenti argomenti:
