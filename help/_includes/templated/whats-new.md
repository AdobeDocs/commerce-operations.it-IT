...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>Sono stati aggiornati i passaggi per verificare la versione delle dipendenze del servizio nell'interfaccia utente di Cloud e il collegamento alla guida su come i clienti possono generare un report di compatibilità per l'aggiornamento per il proprio archivio, in <a href="https://experienceleague.adobe.com/en/docs/commerce-operations/release/planning/security-enforcement-policy#action-1-verify-and-upgrade-third-party-software-dependencies">Verificare e aggiornare le dipendenze del software di terze parti</a>.</p>
</td>
      <td>
        Tecnico
      </td>
...
<table style="table-layout:auto;">
  ...
  <tbody>
    ...
    <tr>
      <td><p>È stata aggiunta una descrizione dettagliata della correzione QPT 1.1.82 per <a href="https://experienceleague.adobe.com/en/docs/commerce-operations/tools/quality-patches-tool/patches-available-in-qpt/v1-1-82/acp2e-4695">ACP2E-4695: Errori di memoria esaurita nell'indicizzatore della regola del catalogo causati da un utilizzo eccessivo della memoria</a>.</p>
</td>
      <td>
        Nuovo argomento, qpt
      </td>
    ...
    <tr>
      <td><p>Sono stati corretti gli errori di battitura nelle date EOS per le versioni 2.4.5 e 2.4.6 di Adobe Commerce.</p>
</td>
      <td>
        Tecnico
      </td>
...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>PHP 8.4 è stato rimosso come versione PHP supportata nelle <a href="https://experienceleague.adobe.com/en/docs/commerce-operations/release/notes/adobe-commerce/2-4-9#php-and-composer">2.4.9 note sulla versione</a>, in quanto non è consigliato per l'utilizzo in produzione ed è presente solo per la compatibilità con l'aggiornamento.</p>
</td>
      <td>
        Note sulla versione, tecniche
      </td>
      <td><a href="https://github.com/AdobeDocs/commerce-operations.en/commit/603bb70012a2f92ceeaad644d5252c4677a1a47c">commit</a></td>
    </tr>
    <tr>
      <td><p>È stata aggiunta una descrizione dettagliata della correzione QPT 1.1.82 per <a href="https://experienceleague.adobe.com/en/docs/commerce-operations/tools/quality-patches-tool/patches-available-in-qpt/v1-1-82/acp2e-4894">ACP2E-4894: i nuovi ordini vengono visualizzati nella griglia Ordini amministratore con un ritardo quando l'indicizzazione asincrona è abilitata</a>.</p>
</td>
      <td>
        Nuovo argomento, qpt
      </td>
    ...
    <tr>
      <td><p>È stata aggiunta una descrizione dettagliata della correzione QPT 1.1.82 per <a href="https://experienceleague.adobe.com/en/docs/commerce-operations/tools/quality-patches-tool/patches-available-in-qpt/v1-1-82/acp2e-4698">ACP2E-4698: la modifica in linea del testo di Page Builder salva gli URL multimediali assoluti invece della direttiva portatile</a>.</p>
</td>
      <td>
        Nuovo argomento, qpt
      </td>
    ...
    <tr>
      <td><p>Sono state corrette e completate le date di fine del supporto, del supporto esteso e delle correzioni di sicurezza aggiuntive per il provisioning di diverse righe della versione di Adobe Commerce nella pagina <a href="https://experienceleague.adobe.com/en/docs/commerce-operations/release/versions">Versioni rilasciate</a>.</p>
</td>
      <td>
        Tecnico
      </td>
...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>Aggiornamento di <a href="https://experienceleague.adobe.com/en/docs/commerce-operations/installation-guide/system-requirements">Requisiti di sistema</a> per aggiungere RabbitMQ 3.13 come versione supportata per Adobe Commerce 2.4.4-p18 (più recente), risolvendo un blocco per il percorso di aggiornamento del sistema operativo Debian.</p>
</td>
      <td>
        Tecnico
      </td>
...
<table style="table-layout:auto;">
  ...
  <tbody>
    ...
    <tr>
      <td><p>È stata aggiornata la tabella <a href="https://experienceleague.adobe.com/en/docs/commerce-operations/release/product-availability">Disponibilità del prodotto</a> con supporto Adobe Commerce 2.4.9 ed è stata rimossa la voce Page Builder, che fa parte del prodotto di base dalla versione 2.4.3.</p>
</td>
      <td>
...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>È stata corretta la matrice di supporto per la versione dell'estensione B2B in <a href="https://experienceleague.adobe.com/en/docs/commerce-operations/release/product-availability">Disponibilità del prodotto</a> per Adobe Commerce 2.4.6, 2.4.7 e 2.4.8.</p>
</td>
      <td>
        Tecnico
      </td>
...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>Aggiunta <a href="https://experienceleague.adobe.com/en/docs/commerce-operations/tools/quality-patches-tool/patches-available-in-qpt/v1-1-82/overview">Panoramica: Strumento Patch di qualità (QPT) v1.1.82</a>.</p>
</td>
      <td>
        Nuovo argomento, qpt
      </td>
