...
* _AC-12128_:
   * _Correzione nota_: [Cloud] Vulnerabilità di sicurezza Prototype.js CVE-2020-27511
   * _Problema GitHub_: &lt;<https://github.com/magento/magento2/commit/de4dfb8e>>
   * _Contributo del codice GitHub_: è necessario risolvere la vulnerabilità di sicurezza CVE-2020-27511
...
* _AC-12950_: aggiorna tinymce 7.3.0 in compositore.json e rimuovi da file da tinymce 7
   * _Correzione nota_: rendere TinyMCE 7.x una versione supportata per Adobe Commerce 2.4.8-beta1
   * _Contributo codice GitHub_: &lt;https://github.com/magento/magento2/ (interno, non unito)>
