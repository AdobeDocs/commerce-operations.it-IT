...
Sono stati risolti 221 problemi nel codice core del Magento Open Source 2.4.8. Di seguito è descritto un sottoinsieme dei problemi risolti inclusi in questa versione.
...
* _AC-9922_: Errore CSP Google Analytics https://region1.analytics.google.com
   * _Correzione nota_: il sistema ora consente correttamente le connessioni a &#39;https://region1.analytics.google.com&#39; quando le Google Analytics sono abilitate, evitando errori CSP (Content Security Policy). In precedenza, l’abilitazione delle Google Analytics e la visualizzazione del sito web dall’UE generavano errori nella console CSP a causa del rifiuto di connettersi a &quot;https://region1.analytics.google.com&#39;&quot;.
...
* _AC-9712_: differenza in termini di compilazione inferiore tra la libreria php e nodejs (grunt) con espressioni `calc` complicate
   * _Correggi nota_: correggi la differenza in termini di minore compilazione tra la libreria php e nodejs (grunt)
...
* _AC-8358_: [Problema] Rimuovi tag `@author` non consentito
   * _Correzione nota_: il sistema ora rispetta gli standard di codifica rimuovendo il tag `@author` non consentito da alcuni moduli, migliorando la qualità e la coerenza del codice. In precedenza, la presenza di questo tag in alcuni moduli violava gli standard di codifica stabiliti.
   * _Problema GitHub_: <https://github.com/magento/magento2/issues/37264>
   * _Contributo codice GitHub_: <https://github.com/magento/magento2/pull/37014>
* _AC-8360_: [Problema] Rimuovi tag `@author` non consentito
   * _Correzione nota_: il sistema ora rispetta gli standard di codifica rimuovendo il tag `@author` non consentito da alcuni moduli, migliorando la qualità generale del codice. In precedenza, la presenza di questo tag in alcuni moduli violava gli standard di codifica stabiliti.
   * _Problema GitHub_: <https://github.com/magento/magento2/issues/37261>
   * _Contributo codice GitHub_: <https://github.com/magento/magento2/pull/37011>
* _AC-8361_: [Problema] Rimuovi tag `@author` non consentito
   * _Correzione nota_: il sistema ora rispetta gli standard di codifica rimuovendo il tag `@author` non consentito da alcuni moduli, garantendo un codice più pulito e standardizzato. In precedenza, la presenza di questo tag in alcuni moduli violava gli standard di codifica stabiliti.
   * _Problema GitHub_: <https://github.com/magento/magento2/issues/37260>
   * _Contributo codice GitHub_: <https://github.com/magento/magento2/pull/37010>
* _AC-8400_: [Problema] Rimuovi tag `@author` non consentito
   * _Correzione nota_: il sistema ora rispetta gli standard di codifica rimuovendo il tag `@author` non consentito da alcuni moduli, migliorando la qualità generale del codice. In precedenza, la presenza di questo tag in alcuni moduli violava gli standard di codifica stabiliti.
   * _Problema GitHub_: <https://github.com/magento/magento2/issues/37254>
   * _Contributo codice GitHub_: <https://github.com/magento/magento2/pull/37004>
...
* _ACP2E-3002_: [CLOUD] Non è possibile disabilitare l&#39;invio di e-mail dall&#39;interfaccia utente di amministrazione come mostra la documentazione per sviluppatori
   ...
   * _Contributo codice GitHub_: <https://github.com/magento/magento2/commit/c8931218>
* _AC-12462_: impossibile modificare lo stato personalizzato intermedio nell&#39;amministratore tramite il modulo di aggiunta commenti
   * _Correzione nota_: il sistema ora aggiorna correttamente lo stato dell&#39;ordine a &quot;Pronto per il ritiro&quot; quando viene modificato dal modulo &quot;Aggiungi commento&quot; nel pannello di amministrazione, garantendo un tracciamento accurato dell&#39;avanzamento dell&#39;ordine. In precedenza, lo stato dell’ordine rimaneva &quot;Inviato&quot; anche dopo aver tentato di cambiarlo in &quot;Pronto per il ritiro&quot; tramite il modulo &quot;Aggiungi commento&quot;.
   * _Problema GitHub_: <https://github.com/magento/magento2/issues/38917>
   * _Contributo codice GitHub_: <https://github.com/magento/magento2/pull/38923>
...
* _AC-12128_: [Cloud] Vulnerabilità di sicurezza Prototype.js CVE-2020-27511
   * _Correzione nota_: è necessario risolvere la vulnerabilità di sicurezza CVE-2020-27511
   * _Contributo codice GitHub_: <https://github.com/magento/magento2/commit/de4dfb8e>
