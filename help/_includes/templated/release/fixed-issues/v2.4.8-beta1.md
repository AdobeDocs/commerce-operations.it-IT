...
Sono stati risolti 253 problemi nel codice core di Adobe Commerce 2.4.8. Di seguito è descritto un sottoinsieme dei problemi risolti inclusi in questa versione.
...
### Interfaccia utente amministratore, Aggiornamenti - Strumento di compatibilità per l’aggiornamento

* _AC-12829_: l&#39;accesso amministratore con funzionalità OTP si interrompe con Chrome Upgrade 127
...
* _AC-12124_: [Errore casuale] libreria Fotorama non caricata
...
* _AC-11810_: Magento2.4.6-p4 Ordine API semplice Prezzo mancante
...
* _AC-5969_: AlertProcessor - Il #2 dell&#39;argomento ($storeId) deve essere di tipo int, stringa specificata
   ...
   * _Contributo codice GitHub_: <https://github.com/magento/magento2/commit/0574ac23>
* _AC-12880_: compilazione giornaliera di tutte le estensioni in bundle - Non verrà generato il report Allure
   * _Correzione nota_: il report Allure deve essere generato senza errori
...
* _AC-12669_: asserzione della riproduzione di video Vimeo/YouTube non riuscita nei test di Page Builder
...
* _AC-11806_: impossibile aggiornare l&#39;errore di Magento in SchemaBuilder.php alla riga: 253
   * _Problema GitHub_: <https://github.com/magento/magento2/issues/38592>
