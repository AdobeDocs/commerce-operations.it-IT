...
#### Le informazioni sul set di attributi vengono memorizzate nella cache (cache EAV), ma non vengono pulite dopo l’aggiornamento del set di attributi nell’area di amministrazione

Sono stati risolti i valori di attributi di prodotto mancanti dopo l’aggiunta di nuovi attributi a un set di attributi quando la cache EAV è abilitata (invalidamento della cache/comportamento di importazione API).

_AC-12321 - [Problema GitHub](https://github.com/magento/magento2/issues/38827) - [Contributo codice GitHub](https://github.com/magento/magento2/pull/38864)_
...
#### La raccolta file multimediali GraphQl restituisce voci disabilitate.

È stato risolto il problema di ottenere solo le immagini della galleria di file multimediali che non sono disabilitate per un prodotto nella risposta della richiesta graphql.

_AC-1608 - [Problema GitHub](https://github.com/magento/magento2/issues/34342) - [Contributo codice GitHub](https://github.com/magento/magento2/pull/34897)_
...
In precedenza, si inviavano corpi di richiesta o parametri non validi a vari endpoint API REST (come /V1/carts/search, /V1/orders, /V1/products, ecc.) ha generato un generico &quot;Errore interno del server&quot; (500), rendendo difficile la diagnosi dei problemi di input.
...
API REST V1/guest-carts/&lt;cartId>/items/ e V1/carts/mine/items/ ora convalidano &quot;product_options.extension_attributes.custom_options.*.option_id&quot; per assicurarsi che faccia riferimento a un option_id valido per lo SKU dell’elemento del carrello. In precedenza, questo parametro veniva elaborato e salvato nel database senza convalida.
...
#### La coda [CLOUD] non viene cancellata

È stata migliorata la resilienza del consumatore AMQP bloccando i tentativi di ack/rifiuto non validi sui canali riconnessi.

_ACP2E-4621 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/c12a7510)_
...
#### La convalida telefonica dell&#39;indirizzo del cliente non funziona se non sono presenti caratteri consentiti

Il sistema restituisce un messaggio di errore che indica che il telefono non è valido.

_AC-16227 - [Problema GitHub](https://github.com/magento/magento2/issues/40361) - [Contributo codice GitHub](https://github.com/magento/magento2/pull/40416)_

#### Gli oggetti del sito Web e del Negozio restituiscono gli ID come stringhe

È stato risolto un problema a causa del quale gli ID di siti web e store venivano restituiti come stringhe invece di interi. In questo modo gli errori di tipo vengono risolti in modalità rigorosa, consentendo il corretto funzionamento di EmailNotification::newAccount() e metodi simili.

_AC-16486 - [Problema GitHub](https://github.com/magento/magento2/issues/40469)_

#### La convalida della città del cliente non funziona per i caratteri non consentiti

È stato risolto un problema che consentiva di salvare gli indirizzi dei clienti con caratteri non validi (ad esempio /, @, #, !) nel campo della città. Dopo questa correzione, il sistema convalida e rifiuta correttamente gli indirizzi contenenti caratteri non consentiti.

_AC-16504 - [Problema GitHub](https://github.com/magento/magento2/issues/40521) - [Contributo codice GitHub](https://github.com/magento/magento2/commit/57bad413)_

#### [Problema] Correzione: aumento della lunghezza della colonna IP per il supporto IPv6 in admin_user_session

Attualmente, la colonna ip in admin_user_session è limitata a 15 caratteri, un numero insufficiente per gli indirizzi IPv6 (fino a 45 caratteri). Questa PR aumenta la lunghezza a 45 per garantire la piena compatibilità IPv6 e impedire il troncamento dei dati o errori quando si utilizza IPv6.

_AC-16659 - [Problema GitHub](https://github.com/magento/magento2/issues/40570) - [Contributo codice GitHub](https://github.com/magento/magento2/pull/40563)_
...
#### La convalida del nome della città accetta caratteri non consentiti (!&quot;#?)

Quando si immette una città in un indirizzo del cliente, la convalida ora consente una barra e rifiuta correttamente caratteri non validi come !, &quot;, # e ?.

_ACP2E-4527 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/f2fd9628)_

#### Convalida degli indirizzi che interrompe il cliente esistente dopo l’aggiornamento a 2.4.8-p3

In precedenza, prima di questa correzione, i numeri di telefono moderni con i caratteri . o \ non sono stati convalidati correttamente. Dopo l&#39;applicazione di questa correzione, i numeri di telefono moderni con i caratteri . o \ sono ora convalidati.

_ACP2E-4554 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/aa2e16d1)_
...
#### [Cloud] PHPSESSID modificato dopo la richiesta di reimpostazione della password e la cancellazione del carrello corrente

Prima della correzione, l’invio del modulo per password dimenticata causava la distruzione/rigenerazione della sessione (PHPSESSID modificato) e l’eliminazione del carrello guest. Dopo la correzione, l’invio del modulo per la password dimenticata lascia la sessione invariata e il carrello guest viene mantenuto.

_ACP2E-4524 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/aa2e16d1)_
...
#### [Problema] Correzione (amministratore): la posizione corretta del datepicker all&#39;interno della diapositiva modale

Questa richiesta di pull risolve un problema di visualizzazione non corretta del datepicker di Magento nelle finestre di dialogo modali di amministrazione.
Ad esempio, questo problema ha interessato la sezione Determinazione prezzi avanzata durante la modifica o la creazione di un prodotto dal pannello di amministrazione.

_AC-16378 - [Problema GitHub](https://github.com/magento/magento2/issues/40468) - [Contributo codice GitHub](https://github.com/magento/magento2/pull/40225)_

#### Il valore FPT nella pagina del carrello e nella pagina del prodotto sono diversi per le stesse configurazioni

È stato risolto un problema a causa del quale i valori FPT (Fixed Product Tax) venivano visualizzati in modo diverso nelle pagine dei prodotti e nelle pagine del carrello a causa di incongruenze negli arrotondamenti. Dopo questa correzione, i prezzi FPT ora sono coerenti tra le pagine di catalogo, prodotto e carrello, eliminando le incongruenze.

_AC-16550 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/8391dbcc)_
...
I colori al passaggio del mouse vengono ora applicati come previsto nelle righe delle griglie statiche di amministrazione.[GitHub-35358](https://github.com/magento/magento2/issues/35358)
...
#### Impossibile aggiornare la configurazione dell’archivio nel pannello di amministrazione

In precedenza, la cache locale, la cache non aggiornata e Redis potevano diventare non sincronizzate quando Redis non era disponibile. Le modifiche alla configurazione apportate durante le interruzioni di Redis non venivano applicate correttamente dopo il recupero di Redis, causando la persistenza di valori non aggiornati. Questa correzione assicura la corretta sincronizzazione tra tutte le cache in modo che i valori salvati più recenti vengano mantenuti e visibili anche quando Redis non è attivo.

_ACP2E-4447 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/e2b23caa)_

#### La griglia di archiviazione non viene sincronizzata con i dati dell&#39;ordine più recenti quando è abilitata l&#39;indicizzazione asincrona della griglia

Nella griglia di archiviazione degli ordini di vendita viene ora visualizzato lo stato corretto degli ordini con indicizzazione asincrona

_ACP2E-4493 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/f2fd9628)_

#### Attributo del prodotto Modifiche di massa tipo di prodotto Virtual->Simple

Impedisce il &quot;Questo ha un peso?&quot; l&#39;attivazione dei controlli prima dell&#39;inserimento dei pannelli degli attributi per l&#39;aggiornamento di massa, evitando modifiche involontarie del peso per i prodotti virtuali.

_ACP2E-4500 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/e2b23caa)_

#### Testo sovrapposto nei PDF delle fatture a più pagine quando il nome del prodotto e le opzioni personalizzate sono lunghi

Prima della correzione, nei PDF Fattura, Spedizione, Nota di credito e Restituzioni con più pagine, i nomi di prodotti lunghi con opzioni personalizzate potevano sovrapporsi a colonne/elementi adiacenti dopo le interruzioni di pagina, rendendo illeggibili le sezioni delle voci.
Dopo la correzione, gli elementi riga ora scorrono correttamente tra le pagine e i nomi e le opzioni lunghi vengono visualizzati senza sovrapposizioni nei PDF Fattura, Spedizione, Nota di credito e Restituzione.

_ACP2E-4630 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/d8a248cd)_

#### [Cloud] l&#39;editor HugeRTE blocca le emoticon dopo l&#39;aggiornamento

Prima della correzione, la convalida di WYSIWYG/PageBuilder bloccava incondizionatamente il contenuto moderno delle emoji a 4 byte a causa di una regola dell’interfaccia utente applicata in modo troppo ampio, anche nelle installazioni in cui il percorso di archiviazione effettivo era utf8mb4-safe. Dopo la correzione, la convalida viene decisa in base al percorso di persistenza reale controllando il set di caratteri/regole di confronto della connessione DB attivo insieme alle regole di confronto della colonna del contenuto di destinazione, in modo che il contenuto sicuro utf8mb4 sia consentito mentre i percorsi utf8/utf8mb3 rimangono protetti.

_ACP2E-4675 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/c58a8ad0) - [Contributo codice GitHub](https://github.com/magento/magento2-page-builder/commit/5fd20dbb)_

#### [I percorsi immagine cloud] sono assoluti alla seconda modifica in Pagebuilder

È stato risolto un problema a causa del quale la modifica in linea del testo di Page Builder poteva salvare gli URL assoluti delle immagini multimediali dopo aver modificato nuovamente un&#39;immagine, invece di mantenere la direttiva portatile `{{media url=...}}`.

_ACP2E-4698 - [Contributo codice GitHub](https://github.com/magento/magento2-page-builder/commit/5fd20dbb)_
...
### Interfaccia utente amministratore, catalogo, prestazioni

#### Scarse prestazioni della chiamata di ricezione in Media Gallery

Sono state migliorate le prestazioni di Media Gallery modificando il caricamento della struttura di directory all’espansione del nodo on-demand invece di creare la struttura completa in anticipo, riducendo in modo significativo il tempo di risposta iniziale ottenuto su strutture di directory multimediali di grandi dimensioni

_ACP2E-4605 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/c12a7510)_
...
### Interfaccia utente amministratore, cliente/clienti

#### Il pulsante di ripristino del modulo dell’interfaccia utente non funziona come previsto per il campo &quot;Associa all’azienda&quot; nella pagina di aggiunta e modifica del cliente

È stato risolto un problema che impediva al pulsante Reimposta di reimpostare correttamente il campo &quot;Associa a società&quot; nel modulo di aggiunta/modifica del cliente. Il modulo ora ripristina correttamente tutti i campi senza ricaricare la pagina, ripristinando il comportamento previsto.

_AC-16364_

### Interfaccia utente amministratore, Importa/esporta

#### Il file CSV di esportazione è disponibile per il download quando l’esportazione non è terminata

Prima della correzione, i file di esportazione dei prodotti in coda venivano scritti direttamente nella posizione finale in var/export, in modo che la griglia di esportazione dell’amministratore potesse visualizzarli e consentire il download prima del termine della generazione. Di conseguenza, gli utenti potevano scaricare file CSV vuoti o parzialmente generati, e i file non correlati presenti in var/export potevano anche apparire nell&#39;elenco di esportazione ed essere scaricabili.
Dopo la correzione, le esportazioni in coda vengono scritte in un file temporaneo e pubblicate nel percorso di esportazione finale solo al termine della generazione. La griglia di esportazione e l’azione di download dell’amministratore ora espongono solo i file di esportazione completati il cui formato corrisponde alle opzioni di Formato file di esportazione configurate, impedendo i download parziali ed escludendo i file non correlati dall’interfaccia utente.

_ACP2E-4724 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/c58a8ad0)_
...
### Interfaccia utente amministratore, Ordine, Pagamenti

#### Impossibile elaborare il rimborso parziale - mancata corrispondenza nel calcolo del rimborso

Il rimborso dell&#39;ordine online ora funziona correttamente. Precedentemente, generava questo errore &quot;Il gateway PayPal rifiuta la richiesta. Errore interno&quot;.

_ACP2E-4615 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/c58a8ad0)_

### Interfaccia utente amministratore, Prestazioni

#### Grave lentezza nel pannello di amministrazione dell’area di gestione temporanea durante il salvataggio del prodotto

Il salvataggio/modifica dei moduli dei prodotti di amministrazione è più veloce per i set di attributi di grandi dimensioni, in quanto consente di ridurre i costosi passaggi di convalida lato client e di mantenere il comportamento di convalida esistente. Questo riduce la possibilità che &quot;page unresponsive&quot; si blocchi nell’interfaccia utente di amministrazione.

_ACP2E-4488 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/f2fd9628)_

### Interfaccia di amministrazione, prodotto

#### [Cloud] RequireJS mixins.js causa il caricamento di script duplicati per tutti i moduli deps.

Prima della correzione alcuni file JavaScript della vetrina potevano essere richiesti ed eseguiti due volte, causando caricamenti duplicati intermittenti e un comportamento instabile. Dopo la correzione, le dipendenze di JavaScript vengono caricate una sola volta, eliminando le richieste duplicate e mantenendo intatta la funzionalità mixin esistente.

_ACP2E-4626 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/c12a7510)_
...
#### Problema di gestione dell’input nel campo Data di scadenza dell’account della carta regalo

Quando crei o modifichi un account gift card in Admin, il campo Data di scadenza viene ora convalidato in modo appropriato. In precedenza, i valori immessi manualmente che non corrispondevano a un formato di data valido potevano essere elaborati in modo errato al momento del salvataggio dell’account.
...
#### [Problema] Aggiunto il inserisco nell&#39;elenco Consentiti di scp per l&#39;analisi se utilizzi solo Google Analytics
...
#### [Problema] Correzione delle prestazioni per il processo cron analytics_collect_data a lungo termine

Sono state ottimizzate le prestazioni del processo cron analytics_collect_data per i database di grandi dimensioni aggiornando le query di convalida dei report in modo da utilizzare LIMIT 1 invece di LIMIT 0. In questo modo si evita il caricamento superfluo di dati completi della tabella durante la convalida e si riduce notevolmente il tempo di esecuzione. Nessun impatto funzionale, miglioramento completamente retrocompatibile.

_AC-16639 - [Problema GitHub](https://github.com/magento/magento2/issues/40590) - [Contributo codice GitHub](https://github.com/magento/magento2/pull/40463)_
...
#### Picco massimo di I/O del disco sui nodi di servizio a causa del processo Cron aggregate_sales_report_order_data

È stato risolto il problema che causava la generazione di un numero eccessivo di ordini aggregati giornalieri, con conseguenti picchi di I/O su disco e deterioramento delle prestazioni. Dopo la correzione, il rapporto viene generato in modo tempestivo.

_ACP2E-4363 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/e2b23caa)_

#### [CLOUD] peggioramento delle prestazioni a causa dell&#39;esecuzione di analytics_collect_data cron

Migliora le prestazioni relative al processo cron di Analytics.

_ACP2E-4496 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/f2fd9628)_
...
#### Procedi a Pagamento e richiedi un preventivo non visibile nel carrello dopo l&#39;assegnazione del cliente alla società durante l&#39;accesso

È stato risolto un problema a causa del quale, quando un cliente viene assegnato a un’azienda durante l’accesso nella vetrina, i pulsanti &quot;Procedi al pagamento&quot; e &quot;Richiedi un preventivo&quot; non erano visibili nella pagina del carrello. Dopo questa correzione, entrambi i pulsanti vengono visualizzati immediatamente senza richiedere al cliente di disconnettersi e accedere nuovamente.
...
#### [B2B] La pagina Preventivi personali non mostra virgolette se alcune virgolette contengono prodotti eliminati

Ora le virgolette vengono visualizzate correttamente quando alcune di esse contengono prodotti eliminati.

_ACP2E-4608 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/c12a7510)_
...
#### Più coupon non funzionano come previsto per Google Pay

È stato risolto un problema a causa del quale più codici coupon non funzionavano come previsto nel foglio paga di Google Pay Express. In precedenza, l’applicazione di un secondo codice coupon rimuoveva erroneamente lo sconto del primo coupon e mostrava totali imprecisi. Anche la rimozione dei coupon non aggiornava correttamente il foglio paga.
I clienti possono ora applicare più codici coupon nel foglio di pagamento Google Pay Express e tutti gli sconti vengono riflessi accuratamente.

_BUNDLE-3507_

#### Braintree SDK riceve chiamate su ogni pagina per ottenere il token del cliente anche se il messaggio Pay Later (Paga più tardi) è disabilitato

Braintree SDK stava effettuando una chiamata per recuperare il token client a ogni caricamento di pagina, anche quando il messaggio Paga più tardi era disabilitato. Ciò ha comportato richieste non necessarie e potenziali problemi di prestazioni.
Il sistema ora richiede il token client Braintree solo se sono abilitati sia il metodo di pagamento PayPal che il messaggio Paga più tardi per il carrello. In questo modo si evitano richieste di token non necessarie e si migliorano le prestazioni di caricamento delle pagine.

_BUNDLE-3508_

#### Interrompere il rendering del modello di vaulting e dei file js dei metodi di pagamento Braintree nella sezione &quot;Metodi di pagamento memorizzati&quot; nell&#39;area dell&#39;account cliente

Il rendering dei file JavaScript e modello per i metodi di pagamento di Braintree veniva eseguito nella sezione &quot;Metodi di pagamento memorizzati&quot; dell’area dell’account del cliente, anche quando i metodi di pagamento e le configurazioni di vaulting di Braintree erano disabilitati. Questo causava errori non necessari nella console del browser.
Il sistema ora controlla se il metodo di pagamento Braintree e la relativa configurazione di vaulting sono abilitati prima di eseguire il rendering dei file e dei moduli correlati. I modelli e gli script di vaulting verranno visualizzati nella sezione &quot;Metodi di pagamento memorizzati&quot; solo se entrambi sono abilitati.

_BUNDLE-3509_

#### Problemi di compatibilità con Apple Pay e Google Pay di terze parti

I clienti hanno riscontrato errori durante il tentativo di effettuare pagamenti tramite Apple Pay o Google Pay utilizzando estensioni di pagamento di terze parti (come Hyvä Checkout) o personalizzazioni. In particolare, Apple Pay generava un errore di tipo a causa di un nome commerciante mancante e Google Pay poteva anche non riuscire a seconda delle interazioni con il codice personalizzato.
Sono stati risolti i problemi di compatibilità con Apple Pay e Google Pay. Il sistema ora gestisce correttamente le estensioni e le personalizzazioni di pagamento di terze parti, garantendo che i valori di configurazione richiesti siano presenti e restituiti correttamente.

_BUNDLE-3510_

#### Google Pay tramite Braintree comporta un caricamento infinito durante il pagamento

Quando Google Pay era abilitato tramite Braintree, il processo di pagamento entrava in uno stato di caricamento infinito dopo aver selezionato Google Pay come metodo di pagamento. Questo impediva ai clienti di completare gli ordini, senza che venisse fornito alcun messaggio di errore o feedback.
L&#39;integrazione di Google Pay tramite Braintree è stata corretta per garantire che il flusso di pagamento proceda come previsto. I clienti possono ora selezionare Google Pay durante il pagamento, completare il processo di pagamento e effettuare gli ordini con successo.
...
#### Il subtotale mostra 0 dopo l’estrazione con più indirizzi e l’aggiunta di un’opzione diversa dal prodotto configurabile

È stato risolto un problema a causa del quale il subtotale del carrello veniva erroneamente visualizzato come 0 dopo l’aggiunta di un’opzione diversa di un prodotto configurabile in seguito al pagamento di più indirizzi. Il subtotale ora riflette correttamente il valore effettivo del carrello.

_AC-14460 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/57bad413)_
...
#### [Problema] Richiama RemoveItem sul carrello anziché ItemRepository

Sostituisce le chiamate deleteById in CartItemRepository con removeItem nell&#39;istanza del carrello.
In questo modo, gli osservatori previsti vengono attivati e l’elemento viene effettivamente aggiornato anche sull’oggetto carrello, anziché solo nel database.

_AC-15963 - [Problema GitHub](https://github.com/magento/magento2/issues/40255) - [Contributo codice GitHub](https://github.com/magento/magento2/pull/40248)_
...
#### Sconto regola prezzo carrello non funzionante con condizione SKU di esclusione

È stato risolto un problema a causa del quale le regole del prezzo del carrello venivano erroneamente applicate anche quando gli SKU esclusi erano presenti nel calcolo del subtotale. La logica dello sconto ora ignora correttamente gli elementi esclusi durante la valutazione delle condizioni della regola.

_AC-16417 - [Problema GitHub](https://github.com/magento/magento2/issues/40503) - [Contributo codice GitHub](https://github.com/magento/magento2/commit/8391dbcc)_
...
#### [Problema CLOUD] nell&#39;applicazione di una gift card con Recaptcha v2 (&quot;Io non sono un robot&quot;)

Le carte regalo ora vengono applicate correttamente quando reCAPTCHA v2 (&quot;Io non sono un robot&quot;) è abilitato, dopo la convalida reCAPTCHA.

_ACP2E-4410_

#### Viene creata un’offerta nulla quando si utilizza Accedi come cliente da Amministratore

È stato risolto un problema che causava la creazione di virgolette nulle durante il flusso &quot;Accedi come cliente&quot;.

_ACP2E-4472 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/e2b23caa)_

#### Incoerenza nel comportamento dei prodotti in bundle con spedizione a tariffa fissa e spedizione gratuita

Prima della correzione, la spedizione gratuita non veniva calcolata correttamente per i prodotti bundle quando forniti tramite le regole di sconto del carrello. Dopo la correzione, la spedizione gratuita viene calcolata correttamente per i prodotti bundle.

_ACP2E-4536 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/c12a7510)_

#### Impossibile ordinare i prodotti con SKU numerici

Il sistema non genera più un errore durante l’ordine di un prodotto con SKU numerica.

_ACP2E-4669 - [Contributo codice GitHub](https://github.com/magento/inventory/commit/83d11138)_

#### Le regole di convalida dell&#39;attributo dell&#39;indirizzo del cliente (EAV) sono in conflitto con le regole di convalida hardcoded.

È stata migliorata la convalida telefonica degli indirizzi dei clienti per supportare valori fino a 255 caratteri, allineando i controlli lato server ai limiti del database. La gestione degli errori è stata inoltre perfezionata in modo che i numeri di telefono di lunghezza eccessiva restituiscano un messaggio chiaro specifico per la lunghezza.

_ACP2E-4735 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/c58a8ad0)_
...
#### [Errore inserimento coupon duplicato intermittente] nella tabella quote_coupon

È stato risolto un errore di chiave duplicata intermittente nella tabella quote_coupons quando venivano eseguite contemporaneamente più richieste di unione carrello o di salvataggio dei preventivi.
...
### Carrello e pagamento, prestazioni

#### [TOYOTA] Problema di prestazioni con la classe Magento\Store\Model\System\Store

Miglioramento delle prestazioni relative a più store e siti Web.

_ACP2E-4491 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/e2b23caa)_

### Carrello e pagamento, prezzi, imposte

#### I prezzi dei prodotti del bundle mostrano valori di imposta e valuta errati tra PDP e Cart in un&#39;impostazione a più divise.

I prezzi dei prodotti del bundle ora vengono visualizzati correttamente tra le pagine PDP e Pagamento.

_ACP2E-4673 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/c58a8ad0)_
...
#### Il widget dell’elenco di prodotti del catalogo Magento restituisce un conteggio errato

Il widget Elenco prodotti catalogo Adobe Commerce ora restituisce il conteggio totale e l’impaginazione corretti (ad esempio, 9 elementi nelle pagine configurate).

_AC-14541 - [Problema GitHub](https://github.com/magento/magento2/issues/39863) - [Contributo codice GitHub](https://github.com/magento/magento2/pull/40421)_
...
#### Generazione automatica dei tag Meta: le variabili non possono essere utilizzate più volte

La generazione automatica delle parole chiave meta del prodotto ora sostituisce tutti i segnaposto nella maschera configurata (ad esempio `{{name}}, order {{name}}`), non solo la prima occorrenza.

_AC-14626 - [Problema GitHub](https://github.com/magento/magento2/issues/35670) - [Contributo codice GitHub](https://github.com/magento/magento2/pull/40412)_
...
#### L&#39;ID gruppo clienti della società non viene assegnato all&#39;ID gruppo clienti dell&#39;amministratore della società quando viene modificato l&#39;amministratore della società

Quando si modifica l’amministratore di una società nel B2B, l’ID gruppo clienti del nuovo amministratore della società non veniva aggiornato in modo da corrispondere al catalogo condiviso assegnato alla società. Questo causava la fissazione di prezzi di livello e autorizzazioni per la categoria per il nuovo amministratore in base al gruppo di clienti della società precedente, con prezzi e autorizzazioni non corretti.
Ora il sistema aggiorna correttamente l’ID gruppo clienti dell’amministratore della società quando l’amministratore viene modificato. In questo modo il nuovo amministratore riceve i prezzi di livello e le autorizzazioni di categoria corretti associati al catalogo condiviso della propria azienda.

_AC-14897 - [Problema GitHub](https://github.com/magento/magento2/issues/39964)_
...
#### Problema di mancata corrispondenza tra il sito Web e le scorte per più siti Web

Questa correzione include i valori website_id e store_id delle tabelle product_alert_stock e product_alert_price nella clausola SELECT della raccolta, garantendo che nella griglia di amministrazione venga visualizzato il sito Web corretto in cui è stato sottoscritto ogni avviso.

_AC-15044 - [Problema GitHub](https://github.com/magento/magento2/issues/40027) - [Contributo codice GitHub](https://github.com/magento/magento2/pull/40431)_
...
#### [Problema] è stato corretto un errore durante la visita della pagina di confronto senza elementi

È stato corretto un bug a causa del quale la visita alla pagina di confronto dei prodotti di catalogo senza elementi di confronto causava un errore irreversibile, verificando che l’azione di confronto gestisse in modo sicuro le raccolte di elementi vuote invece di generare eccezioni.

_AC-15746 - [Problema GitHub](https://github.com/magento/magento2/issues/40205) - [Contributo codice GitHub](https://github.com/magento/magento2/pull/40203)_
...
#### L’e-mail di prelievo in-store utilizza ancora metodi legacy

Nessuna descrizione disponibile.

_AC-16380 - [Problema GitHub](https://github.com/magento/inventory/issues/3384) - [Contributo codice GitHub](https://github.com/magento/inventory/pull/3385) - [Contributo codice GitHub](https://github.com/magento/inventory/commit/b4aeda50)_
...
È stato risolto un problema a causa del quale le opzioni dell’elenco a discesa eliminate venivano mantenute durante la creazione degli attributi del prodotto. Il sistema ora rimuove correttamente le opzioni selezionate e riflette il conteggio accurato dopo il salvataggio.

_AC-16437 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/57bad413)_
...
#### [CLOUD] Dipendenza categoria circolare

Prima della correzione era possibile salvare le categorie con dipendenza circolare. Dopo la correzione, questo comportamento viene impedito tramite una regola di convalida.

_ACP2E-4505 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/f2fd9628)_

#### La gerarchia di CMS non aggiorna l’URL gerarchico quando viene modificata la chiave URL della pagina figlio (2.4.8-p3)

È stato risolto un problema che impediva la modifica della chiave URL di una pagina CMS per aggiornare l’URL gerarchico della pagina (ad esempio, /help/my-account rimaneva invariato dopo la ridenominazione in my-account-2). La logica di aggiornamento della gerarchia ora include correttamente il nodo della pagina, quindi il relativo request_url viene aggiornato e il nuovo percorso (ad esempio /help/my-account-2) funziona come previsto.

_ACP2E-4531_

#### Il segnaposto immagine non viene visualizzato come previsto per archivi diversi

Prima della correzione le immagini segnaposto non venivano caricate nel codice archivio quando questo veniva inserito nell’URL. Dopo la correzione, i segnaposto per le immagini sono sensibili all’ambito con o senza il codice store fornito nell’URL.

_ACP2E-4533 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/aa2e16d1)_

#### [CLOUD] Deadlock sulla tabella magento_catalogpermissions_index_product. continuazione

Prima della correzione, l’esecuzione della reindicizzazione del prodotto delle autorizzazioni del catalogo poteva lasciare invariate le righe dell’indice delle autorizzazioni esistenti, pertanto le autorizzazioni per le categorie aggiornate non venivano applicate ai prodotti in modo affidabile.
Dopo la correzione, la reindicizzazione aggiorna correttamente le righe dell’indice delle autorizzazioni esistenti, in modo che le modifiche delle autorizzazioni vengano applicate in modo coerente in termini di accesso alla vetrina, visibilità dei prezzi e disponibilità del pagamento.

_ACP2E-4603_

#### Il cron dell’indicizzatore della regola di destinazione non seleziona i prodotti abilitati solo nell’ambito della visualizzazione archivio

Prima della correzione, i prodotti non abilitati nell’ambito Amministratore non venivano raccolti dall’indicizzatore della regola di destinazione. Ora, dopo la correzione, i prodotti vengono prelevati se sono abilitati in almeno un ambito.
...
#### [Cloud] - Errore durante la selezione del valore catalog_product_entity_int per attribute_type 0 o Null nei prodotti graphql

È stato risolto un problema a causa del quale la query dei prodotti GraphQL con aggregazioni restituiva un errore con valori di attributo o opzioni non validi. La query ora gestisce correttamente i dati non validi e restituisce risultati corretti.

_ACP2E-4529 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/f2fd9628)_
...
#### La struttura di cartelle di Media Gallery scompare quando il nome dell&#39;immagine della categoria inizia con &quot;-&quot; (trattino)

Nessuna descrizione disponibile.

_AC-16544 - [Problema GitHub](https://github.com/magento/magento2/issues/40536)_

#### Quando si salva il blocco CMS con contenuto non valido, viene visualizzato l’errore &quot;Elenco eventi catalogo&quot;. Blocco CMS

È stato risolto un problema che causava la visualizzazione dell’errore &quot;Il blocco CMS contiene contenuti non validi&quot; durante il salvataggio del blocco CMS predefinito &quot;Elenco eventi catalogo&quot;. Dopo questa correzione, il blocco può essere salvato correttamente senza errori nel pannello di amministrazione.

_AC-16686 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/0c9a749b)_
...
#### [ADOBE STOCK] Registri critici su &quot;Impossibile recuperare i risultati dei file di ricerca di Adobe Stock&quot; anche quando l&#39;integrazione è disabilitata.

Il sistema non registra più l’errore &quot;Impossibile recuperare i risultati dei file di ricerca di Adobe Stock&quot; quando l’integrazione di Adobe Stock è disabilitata.

_ACP2E-4634_

#### Errori durante la creazione di nuove pagine e l’utilizzo di Page Builder

È stato risolto un problema che impediva il salvataggio delle pagine CMS in caso di utilizzo di Page Builder.
...
#### La reimpostazione della password di `[Admin][Customer]` per l&#39;amministratore clienti non riesce

È stato risolto un problema che causava un errore di sistema e un arresto anomalo della pagina a causa del ripristino della password di un cliente dal pannello di amministrazione. La reimpostazione della password ora funziona correttamente e invia il collegamento di reimpostazione senza errori, anche nei casi limite che coinvolgono modifiche all’archivio.

_AC-14940 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/3e41a43b)_
...
#### Modulo NewRelic: rimozione delle dipendenze non necessarie

Rimuove la dipendenza non necessaria di magento/magento-compositore-installer dal modulo di reportistica magento/module-new-relic per ripulire l&#39;accoppiamento inutilizzato/stretto nelle dipendenze

_AC-15945 - [Problema GitHub](https://github.com/magento/magento2/issues/40243)_
...
#### Cron captcha_delete_expiry_images non funziona dopo l’aggiornamento a Magento 2.4.8

Prima della correzione, le immagini captcha scadute non venivano più eliminate automaticamente. Dopo la correzione, le immagini captcha scadute vengono eliminate dall’attività cron corrispondente.

_ACP2E-4512 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/e2b23caa)_

### Framework, Prestazioni

#### [CLOUD] query di riconciliazione MySQL lenta nella griglia di vendita cron asincrono - scansione tabella completa, 20+ s, ~14 milioni di righe esaminate

Miglioramento delle prestazioni di riconciliazione asincrona della griglia di vendita mediante il passaggio dell&#39;individuazione degli ID mancanti a finestre entity_id limitate con progressione basata su cursore, riducendo le ripetute scansioni di tabelle di grandi dimensioni su archivi con volumi elevati.

_ACP2E-4585 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/aa2e16d1)_
...
È stata ripristinata la modifica precedente che restituiva errori in un formato diverso. Ora i potenziali errori vengono restituiti in modo coerente, senza interrompere lo schema di GraphQL.
...
#### AC-2.4.9 - Impossibile cercare gli ordini su EDS boilerplate

Il tipo di input della query GraphQL guestOrder è stato aggiornato a GuestOrderInformationInput anziché a OrderInformationInput.

_LYNX-872_

#### [AC-2.4.9] La query del carrello restituisce uno stato di disponibilità errato per i prodotti con inventario multischermo (MSI) e le scorte predefinite sono 0

È stato risolto un problema a causa del quale l’API del carrello restituiva non correttamente is_available: false per i prodotti con un inventario sufficiente da più origini Source Inventory (MSI).

_LYNX-918_

#### [AC-2.4.9] non può impostare l&#39;indirizzo di spedizione/fatturazione di un cliente con GQL setNegotiableQuoteShippingAddress/setNegotiableQuoteBillingAddress

È stato esposto il campo UID nella query GraphQL Indirizzo cliente per abilitare l&#39;impostazione degli indirizzi di spedizione e fatturazione nei preventivi negoziabili.

_LYNX-924_

#### [AC-2.4.9] Elenco ordini | errore interno del server

Garantiva la stabilità dei flussi degli ordini restituendo null per i prodotti acquistati mancanti, evitando eccezioni nella cronologia degli ordini e negli ordini recenti.

_LYNX-937_

#### [AC-2.4.9] Allinea NegotiableQuoteBillingAddressInput con BillingAddressInput

&#39;
Allineamento di NegotiableQuoteBillingAddressInput, BillingAddressInput, ShippingAddressInput e GiftRegistryShippingAddressInput per supportare l&#39;UID dell&#39;indirizzo del cliente durante la deprecazione dell&#39;ID dell&#39;indirizzo del cliente.
Sono state introdotte le mutazioni deleteCustomerAddressV2 e updateCustomerAddressV2 per supportare l’UID dell’indirizzo del cliente e sono state dichiarate obsolete le mutazioni deleteCustomerAddress e updateCustomerAddress esistenti.
...
### GraphQL, Ordine, Prezzi

#### [Cloud] La query SalesGraphQl customerOrders restituisce valori errati per i campi degli elementi dell&#39;ordine

È stato risolto il problema che causava la restituzione da parte della query SalesGraphQl customerOrders di valori originali_price_included_tax e original_row_total_included_tax gonfiati quando i prezzi del catalogo erano impostati su &quot;Imposta inclusa&quot; perché l&#39;imposta veniva applicata una seconda volta ai prezzi che già includevano l&#39;imposta.

_ACP2E-4762 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/c58a8ad0)_
...
#### File CSV di Advanced Pricing, impossibile esportare il file CSV dei prodotti. OOM anche con limite di memoria 4G

Prima della correzione, le esportazioni complete di prodotti e Advanced Pricing potevano non riuscire con un elevato utilizzo di memoria/OOM in cataloghi di grandi dimensioni e la paginazione dell’esportazione del prodotto poteva produrre righe duplicate quando le dimensioni della pagina dinamiche cambiavano durante l’elaborazione. Dopo la correzione, le esportazioni vengono completate con un comportamento della memoria stabile utilizzando l’elaborazione batch di paging, le righe duplicate dalla sovrapposizione di impaginazione vengono eliminate e il contenuto delle righe esportate rimane allineato con l’output della linea di base.

_ACP2E-4587 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/c12a7510)_
...
#### Lo stato di vendita del bundle non viene aggiornato in caso di annullamento dell&#39;ordine

La vendibilità del prodotto del bundle ora viene calcolata correttamente dopo l’annullamento dell’ordine.

_ACP2E-4481 - [Contributo codice GitHub](https://github.com/magento/inventory/commit/96b77663)_

#### Magento consente la vendita in eccesso quando più clienti effettuano ordini contemporaneamente

Con MSI, più clienti potrebbero effettuare ordini per lo stesso prodotto contemporaneamente e superare le scorte disponibili, causando un&#39;overselling. Dopo la correzione, solo un ordine può avere esito positivo per prodotto se i checkout vengono eseguiti contemporaneamente, pertanto non si verifica più la vendita eccessiva.

_ACP2E-4509 - [Contributo codice GitHub](https://github.com/magento/inventory/commit/a33c60f2)_

#### [CLOUD] Timeout se i client hanno più di 140 articoli nel carrello

Le query del database di inventario sono state ottimizzate per caricare con attenzione i dati di inventario durante l’estrazione. Questo elimina la necessità di singole query per ogni SKU, aumentando notevolmente le prestazioni per il pagamento con carrelli acquisti di grandi dimensioni.

_ACP2E-4519 - [Contributo codice GitHub](https://github.com/magento/inventory/commit/40858072)_

### Fedeltà

#### [CLOUD] getCustomerRewardPoints genera un&#39;eccezione quando il cliente non ha punti

I punti di ricompensa del cliente vengono avviati correttamente quando vengono creati tramite l’amministratore.

_ACP2E-4403 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/c12a7510)_
...
#### Il componente AddComment della fattura può generare un errore quando viene chiamato per primo Invoice getComments

Questa PR risolve un bug critico in cui la chiamata di $invoc->getComments() prima di $invoc->addComment() causava un errore irreversibile &quot;Chiamata a una funzione membro addItem() sull’array&quot;. La correzione implementa il controllo del tipo e la conversione corretti tra i tipi di matrice e di raccolta nei metodi di commento del modello di fattura, garantendo che entrambi i metodi possano essere chiamati in qualsiasi ordine senza errori e mantenendo al contempo la compatibilità con le versioni precedenti.

_AC-14848 - [Problema GitHub](https://github.com/magento/magento2/issues/39884) - [Contributo codice GitHub](https://github.com/magento/magento2/pull/40428)_
...
#### Vendite->La colonna &quot;Indirizzo di spedizione&quot; della griglia ordini non è presente nel paese

È stato risolto un problema che impediva alla colonna dell’indirizzo di spedizione nella griglia Ordini amministratore di visualizzare il paese per gli ordini internazionali. L’indirizzo ora include informazioni sul paese, migliorando la visibilità dell’ordine e la facilità d’uso.

_AC-16256 - [Problema GitHub](https://github.com/magento/magento2/issues/40403) - [Contributo codice GitHub](https://github.com/magento/magento2/commit/3e41a43b)_

#### Il consumer di ordini asincroni rifiuta gli ordini con aggiornamento scorte differito: NoThatEntityException in CartManagementPlugin::getActive() (preventivo inattivo)

È stato risolto un problema critico che impediva il pagamento asincrono con aggiornamento delle scorte differito per gli ordini dei clienti. In precedenza, il consumatore aveva generato un&#39;eccezione NoThatEntityException a causa di preventivi inattivi, causando la contrassegnazione degli ordini come Rifiutati anziché In sospeso. Dopo questa correzione, il consumatore elabora correttamente i preventivi inattivi, sposta gli ordini da Ricevuto a In sospeso e regola le quantità vendibili come previsto. Test MFTF AsyncOrderWithAsyncStockReservationTest ora superato.

_AC-16680 - [Contributo codice GitHub](https://github.com/magento/inventory/commit/d3b2ef0b)_
...
#### GraphQL cancelOrder non annulla gli ordini completamente pagati tramite Gift Card

Prima della correzione, un ordine completamente pagato tramite una gift card non passava automaticamente allo stato &quot;chiuso&quot; quando veniva chiamato tramite una mutazione GraphQL. Ora, dopo la correzione, l’ordine passa allo stato chiuso quando viene annullato tramite GraphQL.

_ACP2E-4455 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/e2b23caa)_

#### L’utilizzo del coupon non viene ripristinato in caso di annullamento/rifiuto dell’ordine

Quando annulli un ordine, l’utilizzo del coupon applicato viene reimpostato correttamente anche se la configurazione dello stato dell’ordine è stata modificata. Questo poteva far sì che i coupon rimanessero contrassegnati come utilizzati dopo l’annullamento di un ordine quando erano attive le impostazioni personalizzate dello stato dell’ordine.
...
#### Regole di prezzo del carrello in base al ritardo dei segmenti dei clienti per gli utenti registrati

È stato risolto un problema a causa del quale le regole di prezzo del carrello basate sui segmenti dei clienti non venivano applicate immediatamente per gli utenti registrati. Lo sconto ora si applica correttamente quando si aggiunge al carrello un prodotto idoneo senza richiedere un aggiornamento del token.

_LYNX-814_

#### GQL - il campo quantità in ProductInterface non restituisce la quantità vendibile

È stato risolto un problema di GraphQL a causa del quale il campo Quantità in ProductInterface non restituiva la quantità vendibile.

_LYNX-816_

#### Impossibile restituire null per il campo &quot;SelectedShippingMethod.carrier_code&quot; non nullable

È stato risolto un problema a causa del quale la selezione del secondo metodo di spedizione durante il pagamento con un indirizzo US causava un errore Impossibile restituire null per il campo non nullable &quot;SelectedShippingMethod.carrier_code&quot;. Questa correzione garantisce una navigazione fluida verso l’estrazione senza attivare errori interni del server.

_LYNX-817_

#### [AC-2.4.9] addProductsToCartMutation restituisce 200 in caso di errore

È stato introdotto un nuovo codice di errore, REQUIRED_PARAMETER_MISSING, per gestire gli errori dell’utente quando non sono selezionate opzioni di prodotto configurabili durante l’aggiunta al carrello.

_LYNX-884_

#### [AC-2.4.9] Errore durante la richiesta del campo CartItem.not_available_message o is_available quando il controllo dell&#39;inventario del carrello è disabilitato

È stato corretto un errore che si verificava durante l’accesso a not_available_message o is_available su CartItem quando il controllo dell’inventario del carrello era disattivato.
...
#### Processo Cron bloccato a causa di OOM - richiesta di revisione innodb_buffer_pool_size e PHP memory_limit per cron

L&#39;elaborazione delle transazioni di pagamento è stata migliorata

_ACP2E-4601 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/c12a7510)_
...
#### `[CLOUD][B2B]` `[Mainline]` collo di bottiglia sales_clean_quotes getSize()

Migliorare le prestazioni del processo cron sales_clean_quotes.

_ACP2E-4610 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/c58a8ad0)_

#### Le sottocategorie di ultimo livello mostrano un conteggio di prodotti pari a zero nella struttura delle categorie di amministrazione

Prima della correzione, le categorie foglia non includevano il conteggio dei prodotti quando venivano visualizzate nella struttura delle categorie dell’area amministratore. Dopo la correzione, il conteggio dei prodotti viene visualizzato correttamente per ogni foglia di categoria.

_ACP2E-4689 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/d8a248cd)_

#### Prestazioni delle query lente sulla tabella magento_reward_history a causa dei dati di grandi dimensioni

È stato risolto il problema che causava la lenta esecuzione del processo cron di scadenza dei punti premio su tabelle di grandi dimensioni magento_reward_history. In precedenza, la query utilizzata dalla scadenza dei punti pianificati mancava di indici di database compositi, causando scansioni di tabelle complete su tabelle con milioni di record.
...
#### Ordina o filtra per prezzo non funziona per i prodotti bundle esauriti

Quando l’opzione &quot;Visualizza prodotti esauriti&quot; è abilitata, la pagina di elenco dei prodotti ora filtra e ordina correttamente i prodotti del bundle esaurito in base al prezzo.

_ACP2E-4475 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/f2fd9628) - [Contributo codice GitHub](https://github.com/magento/inventory/commit/a33c60f2)_
...
#### Caratteri con escape non necessari in ProductInterface

Il sistema ora restituisce `>` senza escape nel nome nella risposta di GraphQL.

_AC-15494 - [Problema GitHub](https://github.com/magento/magento2/issues/40178) - [Contributo codice GitHub](https://github.com/magento/magento2/pull/40423)_
...
#### L’indicizzatore incrementale della regola di destinazione non seleziona i prodotti disabilitati

L’indicizzazione incrementale della regola di destinazione ora risponde quando un prodotto è abilitato o disabilitato, garantendo l’aggiornamento dei consigli di vendita correlata/upselling/cross-selling senza una reindicizzazione completa.

_ACP2E-4402_

#### La segmentazione del cliente non funziona correttamente con l’API REST

I segmenti dei clienti basati sul conteggio degli ordini ora vengono aggiornati correttamente quando gli ordini vengono effettuati tramite l’API REST. In precedenza, l’iscrizione al segmento non veniva aggiornata per gli ordini API perché l’osservatore si basava sulla sessione del cliente, che non è disponibile nelle richieste API.

_ACP2E-4590_

#### Impossibile creare la regola del prezzo del carrello con la condizione dell’azione &quot;Categoria (solo elementi figlio)&quot; tramite API REST

È stato risolto il problema che impediva l’esposizione dell’ambito dell’attributo della condizione Prezzo carrello, ad esempio Categoria (solo padre) e Categoria (solo figli), quando le regole venivano recuperate o aggiornate tramite l’API REST.

_ACP2E-4653 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/d8a248cd)_

#### Le regole del prezzo del carrello per la spedizione gratuita non funzionano come previsto per i prodotti bundle

Gestione migliorata della spedizione gratuita

_ACP2E-4720 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/c58a8ad0)_

### Restituisce

#### Problema con la selezione di opzioni semplici durante la restituzione di prodotti bundle

In precedenza, prima dell’implementazione di questa correzione, per i prodotti in bundle con l’opzione di spedire gli articoli separatamente per le restituzioni, la funzione &quot;Seleziona articoli&quot; apriva il blocco popup solo per la prima volta. Dopo aver selezionato o chiuso il blocco popup, non veniva aperto tutte le volte che veniva chiamata la funzione &quot;Seleziona elementi&quot;. Tuttavia, dopo aver applicato questa correzione, il problema è stato risolto e la funzione ora funziona come previsto.
...
#### Messaggio di errore non renderizzato per la richiesta GET

È stato risolto un problema che impediva la visualizzazione immediata dei messaggi di errore per le richieste GET non valide. I messaggi di errore ora vengono visualizzati correttamente senza richiedere azioni utente aggiuntive, migliorando il feedback e la coerenza dell’utente.

_AC-16296 - [Problema GitHub](https://github.com/magento/magento2/issues/40411) - [Contributo codice GitHub](https://github.com/magento/magento2/commit/8391dbcc)_

#### Caratteri mancanti nella traslitterazione

Il sistema ora gestisce correttamente la traslitterazione di caratteri mancanti

_AC-16626 - [Problema GitHub](https://github.com/magento/magento2/issues/40580) - [Contributo codice GitHub](https://github.com/magento/magento2/pull/40581)_
...
#### L&#39;AC-15210 non sembra completo. API REST USPS richiesta in meno di un mese.

L’integrazione dell’API REST USPS in Adobe Commerce (AC-15210) era incompleta. I problemi principali includevano la mancanza di informazioni di tracciamento, la perdita delle impostazioni dei metodi consentiti quando si cambiavano i tipi di API, richieste eccessive che rischiavano di compromettere i limiti di quota e la mancanza di protezione contro gli errori dei limiti di quota &quot;429&quot;. Il superamento della quota ha impedito la visualizzazione delle tariffe di spedizione ai clienti.
L’integrazione dell’API REST USPS è stata migliorata per:
- Fornire informazioni di tracciabilità adeguate per i pacchi spediti.
- Mantenere le impostazioni dei metodi consentiti quando si passa da USPS WEBtools a REST API.
- Evita le richieste non necessarie all&#39;API USPS, riducendo il rischio di raggiungere i limiti di quota.
- Gestisci con cura gli errori relativi al limite di quota &quot;429&quot;, in modo da garantire che le tariffe di spedizione rimangano disponibili per i clienti.

_AC-16577 - [Problema GitHub](https://github.com/magento/magento2/issues/40394) - [Contributo codice GitHub](https://github.com/magento/magento2/commit/15a9362d)_
...
#### Il metodo di spedizione API REST USPS non viene visualizzato durante il pagamento di alcuni prodotti

I metodi di spedizione API REST USPS sono ora disponibili per i prodotti in pagamento.

_ACP2E-4556 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/aa2e16d1)_
...
È stato risolto un problema a causa del quale le modifiche alle regole del prezzo del catalogo tramite aggiornamenti di staging non venivano riportate in modo coerente nel carrello. Dopo questa correzione, quando viene applicato un aggiornamento programmato della regola prezzo, i prezzi dei prodotti in tutte le sezioni del carrello (blocco centrale e blocco di riepilogo) vengono aggiornati correttamente.

_AC-16530 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/57bad413)_
...
#### Problema relativo alla programmazione dei prezzi speciali

Prima della correzione, il prezzo speciale dalla data non veniva salvato correttamente ogni volta che veniva salvata una gestione temporanea aggiornata. Ora, dopo la correzione, le corrispondenti date di inizio e fine dell’aggiornamento del prezzo speciale vengono correlate con le date di inizio e fine dell’aggiornamento di staging.

_ACP2E-4433 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/f2fd9628)_
...
La conversione del prezzo dinamico del prodotto bundle al netto del calcolo delle imposte per l&#39;articolo dell&#39;offerta funziona correttamente.

_ACP2E-4411 - [Contributo codice GitHub](https://github.com/magento/magento2/commit/aa2e16d1)_
...
#### [Problema] SwiftOtter-SOP-348 Abilita la cache di configurazione compilata per l&#39;esecuzione dei test

Migliora le prestazioni dei test di integrazione abilitando la cache compiled_config durante l’esecuzione dei test, riducendo l’utilizzo di CPU e il tempo di esecuzione.

_AC-16018 - [Problema GitHub](https://github.com/magento/magento2/issues/40253) - [Contributo codice GitHub](https://github.com/magento/magento2/pull/40239)_
