...
La seguente documentazione di riferimento è generata da `composer.lock` e copre i pacchetti richiesti inclusi nel Magento Open Source 2.4.7-beta3.

## Dipendenze

`magento/product-community-edition 2.4.7-beta3` ha le seguenti dipendenze:
