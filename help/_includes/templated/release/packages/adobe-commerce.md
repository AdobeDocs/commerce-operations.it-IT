...
La seguente documentazione di riferimento è generata da `composer.lock` e riguarda i pacchetti richiesti inclusi in Adobe Commerce 2.4.6-beta2.

## Dipendenze

`magento/product-enterprise-edition 2.4.6-beta2` ha le seguenti dipendenze:
...
<table>
  ...
  <tr>
    <td>
      <a href="https://github.com/twigphp/Twig.git">ramoscello</a>
    </td>
    <td>libreria</td>
    <td>Twig, il linguaggio di modelli flessibile, veloce e sicuro per PHP</td>
  </tr>
  </tbody>
</table>
