...
La seguente documentazione di riferimento è generata da `composer.lock` e riguarda i pacchetti richiesti inclusi in Adobe Commerce 2.4.7.

## Dipendenze

`magento/product-enterprise-edition 2.4.7` ha le seguenti dipendenze:
