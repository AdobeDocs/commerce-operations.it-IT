...
Abilitare l’elaborazione dell’ordine asincrono? 1 - Sì, 0 - No
- Richiede un valore
...
Sposta le tabelle correlate alle virgolette di pagamento in un server DB separato
...
Nome utente del database secondario
- Predefinito: `root`
- Richiede un valore
...
Password utente del database secondario
- Accetta un valore


### `--connection`

Nome connessione secondario
- Predefinito: `default`
- Accetta un valore
...
Numero massimo di connessioni secondarie consentite (in secondi)
- Predefinito: &quot;
- Accetta un valore
...
Sposta le tabelle relative alle virgolette di pagamento in un server DB separato. Obsoleto a partire dalla versione 2.4.2 e verrà rimosso
...
Checkpoint dell&#39;host del server di database
- Richiede un valore
...
Nome utente del database di estrazione
- Richiede un valore


### `--password`

Pagamento della password utente del DB
- Accetta un valore


### `--connection`

Nome connessione di estrazione
...
Sposta le tabelle relative alle vendite in un server DB separato. Obsoleto a partire dalla versione 2.4.2 e verrà rimosso
...
Host server database di vendita
- Richiede un valore
...
Nome utente del database di vendita
- Richiede un valore


### `--password`

Password utente DB vendite
- Accetta un valore


### `--connection`

Nome della connessione di vendita
- Predefinito: `sales`
- Accetta un valore
...
Controlla solo le utilità della console richieste
- Predefinito: `false`
- Non accetta un valore
