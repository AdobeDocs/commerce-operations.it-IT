...
>[!NOTE]
>
>Le note sulla versione fornite per le versioni pre-GA sono incomplete e soggette a modifiche da parte di GA.
...
Il supporto di PHP 7.4 è stato rimosso da questa versione. Non è possibile eseguire Adobe Commerce su PHP 7.4.
...
* Check-out rapido bullone
* Eventi di I/O Adobe Commerce
...
* Lo schema GraphQL delle regole dell’ordine di acquisto riguarda la funzionalità delle regole di approvazione dell’ordine di acquisto, ad esempio l’aggiunta di regole di approvazione. A seconda del ruolo e delle autorizzazioni dell’azienda, gli utenti dell’azienda possono creare, modificare, eliminare o visualizzare le regole di approvazione.
...
* Adobe Commerce ora restituisce un messaggio informativo quando `addProductsToCart` la query non riesce quando si aggiunge al carrello un prodotto con autorizzazioni insufficienti.
...
* Adobe Commerce non presuppone più erroneamente che una categoria sia l’elemento padre di un’altra categoria in base al percorso della categoria. [GitHub-32464](https://github.com/magento/magento2/issues/32464)
...
* Il valore dell&#39;attributo Consenti più caselle per spedizione per un prodotto in Inventario avanzato viene ora salvato come previsto.
