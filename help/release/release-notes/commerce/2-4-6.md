...
* Elasticsearch 8.x. Vedere [Elasticsearch aggiornamento](../../../upgrade/prepare/prerequisites.md#upgrade-elasticsearch). <!-- AC-6597 -->
...
* I componenti Zend framework (ZF1) che hanno raggiunto la fine del ciclo di vita sono stati rimossi dalla base di codice. Vedi [Modifiche non compatibili con le versioni precedenti in evidenza](https://developer-stage.adobe.com/commerce/php/development/backward-incompatible-changes/highlights/).<!-- AC-1512 -->
...
* [Estrazione rapida bullone](https://experienceleague.adobe.com/docs/commerce-merchant-services/quick-checkout/overview.html)
