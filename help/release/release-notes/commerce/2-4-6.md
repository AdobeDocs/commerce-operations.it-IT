...
Per le ultime discussioni su questi problemi risolti, consulta il [Bollettino sulla sicurezza di Adobe](https://helpx.adobe.com/it/security/products/magento/apsb23-17.html).
...
* [Check-out rapido bullone](https://help.bolt.com/platforms/adobe/adobe-commerce-setup-guide/m2-migrate/)
...
* La griglia prodotti non genera più un’eccezione quando i prodotti bundle hanno un prezzo speciale che supera i 1000. In precedenza, quando si effettuava la ricerca del prodotto per SKU o si passava a **[!UICONTROL Catalog]** > **[!UICONTROL Products]**, Adobe Commerce generava questo errore: `Non Numeric value encountered`. [GitHub-36284](https://github.com/magento/magento2/issues/36284))
...
* I codici coupon possono ora essere esportati correttamente in Excel XML. In precedenza, il file generato non conteneva tutti i codici coupon selezionati, ma solo tutti gli elementi selezionati nel selettore di elementi per pagina.[GitHub-36073](https://github.com/magento/magento2/issues/36073)
...
* È stato aggiunto testo informativo sotto il campo di input `Storefront Properties` dell&#39;attributo `Search Weight` in Admin **[!UICONTROL Stores]** > [!UICONTROL Attributes] > **[!UICONTROL Product]**.
...
**Soluzione**: è ora disponibile un hotfix per questo problema. Vai a [Strumento Patch di qualità: cerca le patch](https://experienceleague.adobe.com/tools/commerce-quality-patches/index.html?lang=it) e cerca la patch ACSD-50814.
...
È possibile installare Adobe Commerce 2.4.6 utilizzando [Composer](https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/composer.html?lang=it).
