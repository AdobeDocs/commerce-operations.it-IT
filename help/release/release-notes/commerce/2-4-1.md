...
* Le fatture create utilizzando REST ora includono informazioni sulla gift card simili alle fatture create nell&#39;amministratore. In precedenza, quando si utilizzava il POST `/V1/order/:id/invoice` per fatturare l&#39;ordine, non veniva visualizzato il codice gift card o l&#39;importo gift card applicato.
