...
* È ora possibile utilizzare `bin/magento sampledata:deploy` per distribuire i dati di esempio come previsto dopo l&#39;installazione di Adobe Commerce tramite Composer. In precedenza, l&#39;applicazione ha generato questo errore: `Git installations must deploy sample data from GitHub; see /help/installation/sample-data/git-repositories.md for more information`. _Correzione inviata da Andrii Beziazychnyi nella richiesta di pull [27481](https://github.com/magento/magento2/pull/27481)_. [GitHub-19481](https://github.com/magento/magento2/issues/19481)
