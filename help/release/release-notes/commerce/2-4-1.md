...
Page Builder ora supporta la modalità a tutto schermo, che supporta una modifica più semplice dei contenuti e offre un’esperienza di modifica coerente per l’amministratore. Vedi [Workspace](https://docs.magento.com/user-guide/cms/page-builder-workspace.html). <!-- PB-543-->
...
Per ridurre la creazione di account fraudolenti o spam, gli esercenti possono ora abilitare Google reCAPTCHA nel modulo di richiesta della nuova azienda sulla vetrina. Vedi [reCAPTCHA](https://docs.magento.com/user-guide/configuration/security/google-recaptcha-storefront.html).<!-- BUNDLE-154 -->
