---
title: Adobe Systems Commerce 2.4.2 note sulla versione
description: Scopri su nuove funzionalità, miglioramenti, correzioni di bug e problemi noti nella versione 2.4.2 di Adobe Systems Commerce.
...
* È stato aggiunto il supporto per più elenchi di desideri. È possibile utilizzare GraphQL per [creare](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-wishlist.html), [eliminare](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-wishlist.html) e [rinominare](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-wishlist.html) elenchi dei desideri, nonché [spostare](https://developer.adobe.com/commerce/webapi/graphql/mutations/move-products-between-wishlists.html) o [copiare](https://developer.adobe.com/commerce/webapi/graphql/mutations/copy-products-between-wishlists.html) elementi tra di essi. <!-- MC-32356-->

* È stato aggiunto il supporto per le autorizzazioni per merci restituite (RMA). Gli acquirenti possono [richiedere un reso](https://developer.adobe.com/commerce/webapi/graphql/mutations/request-return.html). Se il commerciante accetta la richiesta, l&#39;acquirente può eseguire attività come [l&#39;aggiunta di un commento](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-return-comment.html) e [aggiungere informazioni di tracciamento](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-return-tracking.html). <!-- MC-34596-->

* È stato aggiunto il supporto per le seguenti funzionalità B2B:
   * Compagnie. È possibile aggiungere amministratori](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company.html), [utenti](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company-user.html), [ruoli](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company-role.html) e [team](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company-team.html) della società[.<!-- MC-33861-->
   * Credito d&#39;impresa. La [query](https://developer.adobe.com/commerce/webapi/graphql/queries/company.html) aziendale include dettagli sulla storia creditizia della società. <!-- MC-33862-->
   * Elenchi di richieste. È possibile [creare](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-requisition-list.html), [eliminare](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-requisition-list.html) e [aggiornare](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-requisition-list.html) gli elenchi di richieste. Il supporto include anche la possibilità di aggiungere, aggiornare](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-products-in-wishlist.html), [eliminare](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-requisition-list-items.html), [copiare](https://developer.adobe.com/commerce/webapi/graphql/mutations/copy-items-between-requisition-lists.html) e [spostare](https://developer.adobe.com/commerce/webapi/graphql/mutations/move-items-between-requisition-lists.html) articoli all&#39;interno di [un elenco di richieste, nonché aggiungere elementi [dell&#39;elenco di richieste nel carrello](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-requisition-list-items-to-cart.html). [](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-products-to-requisition-list.html)<!-- MC-34312-->

* È stato aggiunto il supporto per i raccordi in GraphQL. [GitHub-29425](https://github.com/magento/magento2/issues/29425) <!-- ENGCOM-8291 -->

* È stato aggiunto il supporto per [gli elenchi di confronto](https://developer.adobe.com/commerce/webapi/graphql/queries/compare-list.html). Gli acquirenti possono [creare](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-compare-list.html) ed [eliminare](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-compare-list.html) elenchi di confronto e [aggiungere](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-products-to-compare-list.html) e [rimuovere](https://developer.adobe.com/commerce/webapi/graphql/mutations/remove-products-from-compare-list.html) elementi negli elenchi di confronto. Inoltre, gli acquirenti che creano un elenco di confronto come ospite possono accedere come clienti e [conservare](https://developer.adobe.com/commerce/webapi/graphql/mutations/assign-compare-list-to-customer.html) i loro elenchi di confronto.

* È stata aggiunta la mutazione e aggiornato l&#39;oggetto per supportare l&#39;assistenza all&#39;acquisto [`generateCustomerTokenAsAdmin`](https://developer.adobe.com/commerce/webapi/graphql/mutations/generate-customer-token-as-admin.html) `Customer` remoto.
...
* È stato aggiunto l&#39;attributo `staging` a [`ProductInterface`](https://developer.adobe.com/commerce/webapi/graphql/interfaces/product-interface.html) e [`CategoryInterface`](https://developer.adobe.com/commerce/webapi/graphql/interfaces/category-interface.html) per determinare se un prodotto è posizionato nell&#39;area intermedia e per visualizzare le informazioni sulla campagna associate. <!-- MC-33897-->
...
**Gli ordini di acquisto possono ora essere completati utilizzando metodi** di pagamento online. B2B acquirenti viene richiesto di selezionare il metodo di pagamento preferito per ogni [ordine](https://experienceleague.adobe.com/en/docs/commerce-admin/b2b/purchase-orders/purchase-order-flow) di acquisto durante il check-out iniziale. Dopo l&#39;approvazione dell&#39;ordine di acquisto, agli acquirenti viene richiesto di immettere dati di pagamento per convertire l&#39;ordine di acquisto a un ordine finale.

Per supportare un workflow completo per l&#39;accettazione di pagamenti online, questa funzione anche:
...
* [Archiviazione di file](../../../configuration/remote-storage/remote-storage.md) media su AWS S3

Il supporto per AWS S3 è stato aggiunto a tutti i moduli, inclusi B2B, PageBuilder e Adobe Stock Integration.

### Framework di test funzionali (MFTF)

MFTF 3.2.1 è ora disponibile. Questa versione introduce la tolleranza di errore sia nei test che nella generazione di suite di test. Ulteriori miglioramenti e correzioni di bug sono descritti nel [Functional Testing Framework Changelog](https://github.com/magento/magento2-functional-testing-framework/blob/develop/CHANGELOG.md).
...
* L&#39;amministratore ora visualizza i dati solo dai siti Web per i quali l&#39;amministratore connesso dispone delle autorizzazioni. In precedenza, l&#39;amministratore visualizzava i dati di tutti i siti Web della distribuzione.

<!-- MC-35027-->

* Tutti i siti Web selezionati vengono ora memorizzati indipendentemente `gws_websites` dalle dimensioni dell&#39;ID del sito Web. In precedenza, gli ID dei siti Web venivano troncati e l&#39;elenco dei siti Web selezionati non veniva archiviato nel database. I ruoli utente non sono stati salvati correttamente e il applicazione visualizzato questo errore quando un commerciante ha tentato di modificare e salvare un ruolo: `The "X" store ID is incorrect. Verify the store ID and try again`.

<!-- MC-37223-->

* L’applicazione ora visualizza il conteggio corretto degli elementi nelle griglie di amministrazione per gli utenti amministratori con restrizioni. In precedenza, i conteggi visualizzati per queste griglie riflettevano i dati per tutti i paesi, mentre le griglie stesse visualizzavano solo dati di paesi specifici. Questa correzione corregge un problema relativo a Segmenti clienti, Regole prezzo catalogo, Regole prezzo carrello, Tutti gli utenti, Utenti bloccati e Griglie ruoli utente.
...
* Il metodo di pagamento PayPal Express Checkout predefinito ora funziona come previsto con il metodo di pagamento Braintree con carta di credito. In precedenza, il applicazione non visualizzava il **pulsante PayPal** quando era abilitato il metodo di pagamento con carta di credito Braintree.

### Prodotti in bundle

<!-- MC-34063-->

* Il applicazione non imposta più i prezzi per gli articoli figlio del pacchetto di prodotti a prezzo fisso nelle virgolette.

<!-- MC-38050-->

* L&#39;ordinamento dei prezzi ora funziona come previsto quando i prodotti in bundle includono prodotti esauriti. In precedenza, l&#39;ordinamento dei prezzi in ordine decrescente non visualizzava i prodotti in ordine decrescente.
...
* Le regole del prezzo di catalogo ora funzionano come previsto con le opzioni personalizzate nelle pagine dei dettagli del prodotto. In precedenza, i prezzi dei prodotti in quella pagina non riflettevano le regole applicabili in materia di prezzi di catalogo. [GitHub-22856](https://github.com/magento/magento2/issues/22856)

<!-- MC-34265-->

* Le cache dei prodotti e dei cataloghi ora scadono come pianificato. In precedenza, le cache scadevano giornalmente perché `сron` eseguivano l&#39;attività `catalogrule_apply_all` una volta al giorno, che reindicizzava tutte le regole di catalogo e gli indicizzatori dipendenti e cancellava la cache per tutti i prodotti e le categorie.

### Pulizia

#### Pulizia di errori di battitura e grammatica

<!-- ENGCOM-7967 -->

* Il titolo della pagina Errore ordine è stato rivisto per verificarne l&#39;accuratezza. Precedentemente, questa pagina si chiamava: **Abbiamo ricevuto il tuo ordine.**.  [GitHub-29416](https://github.com/magento/magento2/issues/29416)
...
* Corretta la posizione dell&#39;elenco di pulsante nella pagina Attributo Nuovo.

<!-- ENGCOM-8315 -->

* Aggiunta la classe di blocco corretta per l&#39;esempio di riferimento frontend `viewModel` per la `\Magento\Framework\View\Element\Template` classe. [GitHub-30450](https://github.com/magento/magento2/issues/30450)
...
* Corretto il commento PHPdoc in `app/code/Magento/CatalogImportExport/Model/Export/Product.php`. [GitHub-30833](https://github.com/magento/magento2/issues/30833)
...
* Rimosse le assegnazioni di variabili ridondanti nella stessa riga in più file. [GitHub-30133](https://github.com/magento/magento2/issues/30133)

<!-- ENGCOM-8263 -->

* Modificato `@param string $attribute` in `@param AbstractAttribute|string[]|string $attribute` in .`EntityAbstract.php` [GitHub-30191](https://github.com/magento/magento2/issues/30191)

<!-- ENGCOM-8142 -->

* I tag non validi (ad esempio, `@package` e `@subpackage`) sono stati rimossi dai docblocks in tutta la codebase. [GitHub-30061](https://github.com/magento/magento2/issues/30061)
...
* La selettore `input[type=datetime]` attributi è stata sostituita con un tipo di input meno specifico selettore. [GitHub-30064](https://github.com/magento/magento2/issues/30064)

<!-- ENGCOM-8282 -->

* Il applicazione visualizza ora i valori specifici di store associati agli attributi di categoria personalizzati come previsto. [GitHub-13440](https://github.com/magento/magento2/issues/13440)

<!-- ENGCOM-8287 -->

* L&#39;applicazione ora visualizza un messaggio che chiede se il gruppo di clienti deve essere modificato quando si fa clic su **Convalida numero** di partita IVA pulsante nella pagina di creazione dell&#39;ordine quando l&#39;indirizzo store e la destinazione di spedizione appartengono a diversi paesi dell&#39;UE. [GitHub-29652](https://github.com/magento/magento2/issues/29652)

<!-- ENGCOM-8031 -->

* La `\Magento\Catalog\Model\ImageUploader` classe è stata sottoposta a nuovo factoring per utilizzare il nuovo `moveFileFromTmp`  metodo. [GitHub-29598](https://github.com/magento/magento2/issues/29598)

<!-- ENGCOM-8178 -->

* Il applicazione ora visualizza un messaggio di errore più informativo quando un commerciante tenta di creare un attributo di prodotto con `product_type` codici e `type_id` codici per essere più descrittivi. [GitHub-28479](https://github.com/magento/magento2/issues/28479)
...
* I valori booleani non sono più impostati per `image_with_border.phtml`. Ridondante `max-width` e impostazioni rimosse `height` da `.product-image-photo`. (Questi valori sono già impostati globalmente sull&#39;immagine tramite gli stili di ripristino.) [GitHub-30186](https://github.com/magento/magento2/issues/30186)

### Importa/esportazione

<!-- MC-35081-->

* All&#39;indirizzo `region_id` cliente non viene più assegnato un `NULL` valore quando si importano gli indirizzi dei clienti utilizzando un file CSV (`entity type = "customer address"` e `import behavior = "add/update"`) da cui sono stati eliminati determinati valori di campo.
...
* Titoli e descrizioni significativi sono stati aggiunti ai test MFTF per i `Company`moduli , `CompanyCredit`, `CompanyPayment`, `CompanyShipping`e `ConfigurableSharedCatalog` . [GitHub-30164](https://github.com/magento/magento2/issues/30164)

#### Nuovo test

<!-- ENGCOM-7804 -->

* È stato aggiunto un test per abilitare l&#39;invio di e-mail a un amico nell&#39;amministratore. [GitHub-29145](https://github.com/magento/magento2/issues/29145)

<!-- ENGCOM-8316 -->

* Aggiunto un test per l&#39;eliminazione di un blocco CMS da una griglia da parte di un amministratore. [GitHub-30372](https://github.com/magento/magento2/issues/30372)

<!-- ENGCOM-7933 -->

* È stato aggiunto un test per l&#39;applicazione di un regola del carrello acquisti a un singolo elemento del bundle. [GitHub-28921](https://github.com/magento/magento2/issues/28921)

<!-- ENGCOM-8075 -->

* Sono stati aggiunti test per verificare se **le informazioni Usato in** per un&#39;immagine di Media Gallery vengono visualizzate dopo l&#39;eliminazione dell&#39;entità. [GitHub-1774](https://github.com/magento/adobe-stock-integration/issues/1774)
...
* È stato eseguito il refactoring di `Magento_Csp/Model/BlockCache` per ridurre sia il consumo di memoria che la generazione di stringhe memorizzate nella cache inutilmente grandi. In precedenza, le pagine che includevano script e stili consentiti dinamicamente presentavano spesso problemi di prestazioni. [GitHub-29964](https://github.com/magento/magento2/issues/29964)

<!-- MC-37816 -->

* Abbiamo migliorato le prestazioni delle esportazioni programmate di cataloghi che includono più di 100.000 prodotti che utilizzano i consumatori.
...
* Gli amministratori con accesso limitato ai soli prodotti in un sito Web specifico ambito ora possono aggiungere un articolo a un lineare di reso quando tale articolo non è più nel loro sito Web ambito.

### Recensioni

<!-- MC-37145-->

* Il numero di classificazioni visualizzate in **Stores** > **Attribute >** **Rating** ora corrisponde al conteggio delle classificazioni in una distribuzione multisito. [GitHub-30258](https://github.com/magento/magento2/issues/30258)
...
* Sono state migliorate le prestazioni della ricerca nel catalogo. La disattivazione di **Abilita suggerimenti di ricerca** (**Archivi** > **Configurazione** > **Catalogo** > **Ricerca catalogo** ) funziona come previsto. In precedenza, l&#39;applicazione eseguiva una query sulla tabella MySQL `search_query` anziché sull&#39;Elasticsearch per i suggerimenti di ricerca per il completamento automatico. [GitHub-25534](https://github.com/magento/magento2/issues/25534)

<!-- MC-35256-->

* Elasticsearch ora filtra i prezzi dei prodotti allo stesso modo di MySQL. Il tipo `price_*`  di campo è stato modificato da `float` a `double` nell&#39;indice Elasticsearch per migliorare la precisione e correggere un errore a virgola mobile.
...
* Elasticsearch non genera più un errore, ma non visualizza alcun prodotto come previsto quando un valore viene utilizzato per filtrare i `string` prodotti per attributo con un `integer` tipo di back-end OR `decimal` . In precedenza, il applicazione visualizzato questo errore in `exception.log`: `number format exception`.

<!-- ENGCOM-8303 -->

* L&#39;Elasticsearch non genera più un&#39;eccezione quando un termine di ricerca contiene `/`.  [GitHub-25886](https://github.com/magento/magento2/issues/25886), [GitHub-25110](https://github.com/magento/magento2/issues/25110)
...
* Ora puoi creare un&#39;etichetta di spedizione come previsto per un ordine parziale. In precedenza, quando si tentava di creare un&#39;etichetta di spedizione per un solo articolo di un ordine, il applicazione aggiunto tutti i prodotti al pacco e convalida non riusciva. [GitHub-29552](https://github.com/magento/magento2/issues/29552)
...
* Le Sitemap generate finora `cron` includono gli URL immagine corretti. In precedenza, il percorso dell&#39;immagine generata nella cache non era corretto nelle distribuzioni multi store.

### Stadiazione

<!-- MC-39046 -->

* La pagina Modifica Home Pagina visualizza ora tutti gli aggiornamenti pianificati come previsto quando si verifica la disponibilità di aggiornamenti pianificati della home page. In precedenza, l’applicazione mostrava solo uno dei diversi aggiornamenti pianificati.
...
* L&#39;applicazione non genera più un errore quando si tenta di pianificare un aggiornamento per una categoria. In precedenza, il applicazione generava questo errore quando si faceva clic su **Salva** nella pagina Pianifica aggiornamento Nuovo: `Something went wrong while saving the Magento\Catalog\Api\Data\CategoryInterface`.

<!-- MC-38455-->

* L&#39;API `rest/V1/products/special-price` può ora essere utilizzata per programmare i prezzi speciali dei prodotti per più negozi. In precedenza, il applicazione generava un errore quando un commerciante pianificava un aggiornamento del prezzo per più negozi per lo stesso `from` e `to` il momento in cui è disponibile un rollback all&#39;ora di inizio del nuovo programmare.
...
* Quando utilizzi POST `V1/order/:orderId/ship` per creare una spedizione parziale, l&#39;endpoint restituisce il numero corretto di prodotti spediti.

<!-- MC-38425-->

* Le fatture create utilizzando POST `V1/order/:orderID/invoice` ora riflettono accuratamente il pagamento parziale tramite store credito. In precedenza, quando un ordine veniva parzialmente pagato con store credito, la fattura veniva creata senza prendere in considerazione il store credito in account.

<!-- MC-36830-->

* Le chiamate GET `rest/all/V1/categories` e GET `rest/all/V1/categories?rootCategoryId=2` ora restituiscono la compilazione `name` e `product_count` i campi come previsto per tutte le categorie nella struttura. In precedenza, i valori dei campi categoria erano vuoti. Il risolutore dei nomi delle tabelle ha restituito plug-in un nome di tabella errato per il recupero del conteggio dei prodotti per categoria.

<!-- ENGCOM-8286 -->

* L&#39;endpoint PUT `V1/categories/:id` ora archivia i dati necessari per creare reindirizzamenti 301 per le chiavi di categoria URL quando viene fornito l&#39;attributo `save_rewrites_history` personalizzato. [GitHub-29174](https://github.com/magento/magento2/issues/29174), [GitHub-30240](https://github.com/magento/magento2/issues/30240)
...
* L&#39;pulsante **Aggiungi al carrello** nella pagina della lista dei desideri condivisa ora funziona come previsto per gli utenti anonimi, ospiti e utenti che non hanno effettuato l&#39;accesso.

<!-- MC-34411-->

* Gli acquirenti possono ora spostare correttamente un prodotto da una lista dei desideri a un&#39;altra.

<!-- ENGCOM-8062 -->

* Il applicazione visualizza ora le opzioni di attributi di prodotto configurabili selezionate nella pagina della lista dei desideri come previsto. [GitHub-24091](https://github.com/magento/magento2/issues/24091), [GitHub-22503](https://github.com/magento/magento2/issues/22503)
...
**Problema**: non è possibile utilizzare la mutazione GraphQL `addConfigurableProductToCart` per aggiungere un prodotto configurabile a un carrello in una visualizzazione archivio non predefinita in una distribuzione multi-store che esegue Inventory. (Le vetrine di Luma non sono interessate). l&#39;applicazione visualizza questo errore: `Could not add item to cart. Please check required options and try again`. **Soluzione alternativa**: utilizzare la mutazione `addProductsToCart`. [GitHub-31660](https://github.com/magento/magento2/issues/31660)<!-- PWA-1298-->
...
**Problema**: l&#39;applicazione crea un ordine nella Braintree come previsto quando un acquirente fa clic su **Paga con Venmo**, ma non crea l&#39;ordine nell&#39;amministratore. **Soluzione**: nessuna. Vedi il [2.4.2 problema noto: Braintree pagamento Venmo non funziona](https://support.magento.com/hc/en-us/articles/360054662652/) Articolo della Knowledge Base.  <!-- BUNDLE-2894-->
