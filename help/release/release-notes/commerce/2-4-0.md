...
>[!NOTE]
>
>**Integrazione dei pagamenti Braintree**: prima della versione 2.4.0, era consigliabile che gli esercenti installassero e configurassero l&#39;estensione ufficiale dell&#39;integrazione dei pagamenti Braintree da Commerce Marketplace per sostituire l&#39;integrazione core. Con questa versione (2.4.0), l’estensione è ora inclusa nella versione. Gli esercenti devono seguire ulteriori passaggi per garantire il corretto funzionamento di Braintree in una distribuzione 2.4.0. Per ulteriori informazioni su come eseguire la migrazione a 2.4.0, vedere [Braintree](https://docs.magento.com/user-guide/payment/braintree.html).
...
* **Acquisti assistiti dal venditore**. Questa funzione consente ai commercianti di visualizzare la vetrina per conto dei clienti. I clienti scelgono di consentire l’accesso ai loro account nella vetrina. Questa funzionalità sviluppata dalla community include un&#39;estensione originale sviluppata da [MAGEFAN](https://magefan.com/). Vedi [Acquisti con assistenza del venditore](https://docs.magento.com/user-guide/configuration/customers/login-as-customer.html). Le caratteristiche includono:
...
Per informazioni dettagliate su questo e altri miglioramenti, consulta la [Guida per gli sviluppatori di GraphQL](https://devdocs.magento.com/guides/v2.4/graphql/). Consulta le [note sulla versione](https://devdocs.magento.com/guides/v2.4/graphql/release-notes.html) per una discussione dettagliata sulle recenti correzioni di bug di GraphQL.
...
**Funzione del flusso di lavoro di approvazione ordine per B2B**. Le approvazioni degli ordini consentono ai responsabili delle organizzazioni di acquisto di configurare le regole di approvazione per i propri acquirenti. Consulta [Regole di approvazione](https://docs.magento.com/user-guide/customers/account-dashboard-approval-rules.html). Le caratteristiche includono:
...
* I test ora coprono il compito di registrare le azioni di amministrazione relative alle pagine CMS. _Correzione inviata da Lukasz Bajsarowicz nella richiesta di pull 172 nei partner dell&#39;archivio privato Magento2ee_. [GitHub-171](https://github.com/magento/magento2/issues/171)
