...
* Nel registro delle azioni in blocco vengono ora visualizzate informazioni sugli errori `to be moved` aggiornamenti pianificati. In precedenza, le informazioni su questi errori erano disponibili nel `cron.log` solo file.
