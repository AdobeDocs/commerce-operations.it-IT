...
* La `Magento\Framework\MessageQueue\TopologyTest` test è ora compatibile con il servizio AWS MQ per RabbitMQ. In precedenza, il test non riusciva con questo messaggio: `Invalid exchange configuration: magento-topic-based-exchange1 Failed asserting that two arrays are equal`. <!-- AC-1248-->
