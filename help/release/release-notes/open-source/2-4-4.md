...
* Magento Open Source ora restituisce un codice di risposta 500 quando si verifica un&#39;eccezione nel file di bootstrap. In precedenza, applicationOpen Source restituiva un codice di stato OK 200. [GitHub-22196](https://github.com/magento/magento2/issues/22196)
...
* Sono state aggiunte nuove opzioni richieste al `.htaccess` e `nginx.conf` file distribuiti con Magento Open Source per il supporto di PHP 8.x. Sono state rimosse anche le opzioni obsolete. [GitHub-34358](https://github.com/magento/magento2/issues/34358)
...
È possibile installare Magento Open Source 2.4.4 utilizzando [Compositore](../../../installation/composer.md).
