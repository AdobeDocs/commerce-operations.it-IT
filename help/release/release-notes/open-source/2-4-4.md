...
A eccezione di [Braintree](https://experienceleague.adobe.com/en/docs/commerce-admin/stores-sales/payments/braintree), tutte le estensioni incluse nel fornitore sono state rimosse dalla base di codice di Magento Open Source 2.4.4. I commercianti devono effettuare la migrazione alle estensioni ufficiali, disponibili nella [Commerce Marketplace](https://marketplace.magento.com/extensions.html).
