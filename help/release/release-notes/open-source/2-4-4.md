...
A eccezione di [Braintree](https://docs.magento.com/user-guide/payment/braintree.html), tutte le estensioni incluse nel fornitore sono state rimosse dalla base di codice di Magento Open Source 2.4.4. I commercianti devono effettuare la migrazione alle estensioni ufficiali, disponibili nella [Commerce Marketplace](https://marketplace.magento.com/extensions.html).
...
* Il Magento Open Source non genera più un errore quando un acquirente fa clic su **Aggiorna carrello** dopo aver modificato una quantità di prodotto nel mini carrello. In precedenza, applicationOpen Source visualizzava questo errore: `The quote item isn't found. Verify the item and try again`.
...
* `bin/magento setup:upgrade` ora viene eseguito come previsto durante l&#39;aggiornamento dal Magento Open Source 2.4.2-p1. In precedenza, applicationOpen Source generava questo errore: `Unable to apply data patch Magento\Paypal\Setup\Patch\Data\UpdateBmltoPayLater for module Magento_Paypal`. [GitHub-33678](https://github.com/magento/magento2/issues/33678)
...
* Il Magento Open Source non visualizza più un errore durante il pagamento con il metodo PayPal Express. In precedenza, anche se il processo di estrazione è stato completato, l&#39;applicazione Open Source visualizzava questo errore: `Something went wrong`.
...
* Magento Open Source ora visualizza i prodotti correlati, i prodotti di upselling e i prodotti di cross-selling in base alle loro posizioni nell’amministratore.
...
È possibile installare il Magento Open Source 2.4.4 utilizzando [Compositore](../../../installation/composer.md).
