...
* HTTPS ora è abilitato per impostazione predefinita per la vetrina del Magento Open Source. La **Utilizzare URL sicuri su Storefront** e **Utilizzare gli URL protetti in Amministratore** Le impostazioni sono abilitate per impostazione predefinita e tutti i cookie incorporati sono ora impostati come sicuri.  <!-- AC-1173-->
...
* Gli sviluppatori ora possono configurare il limite per le dimensioni degli array accettati dagli endpoint RESTful di Magento Open Source in base all’endpoint. Vedi [Sicurezza API](https://developer.adobe.com/commerce/webapi/get-started/api-security/). <!-- AC-465-->
...
* Il Magento Open Source ora copia tutti i campi di prodotto in base all’ambito definito durante la duplicazione di un prodotto. Precedentemente, la **name** e **descrizione** i campi sono stati reimpostati su `global` ambito di applicazione.
