...
A eccezione di [Braintree](https://experienceleague.adobe.com/it/docs/commerce-admin/stores-sales/payments/braintree), tutte le estensioni incluse nel fornitore sono state rimosse dalla base di codice di Magento Open Source 2.4.4. I commercianti devono effettuare la migrazione alle estensioni ufficiali, disponibili in [Commerce Marketplace](https://commercemarketplace.adobe.com//extensions.html).
...
* Il prezzo minimo annunciato **Cos&#39;è?** ora è possibile fare clic sul collegamento nella pagina del carrello e apre il pop-up di informazioni come previsto. In precedenza, fare clic su questo collegamento non aveva alcun effetto.
...
* Il metodo `str_contains` non supportato è stato sostituito con una funzione supportata. Questo era un problema noto per Magento Open Source 2.4.3. [GitHub-33680](https://github.com/magento/magento2/issues/33680)
...
* La chiamata PUT `/rest/all/V1/categories/<above_created_category_id>` ora rispetta i valori specificati da `available_sort_by`.  In precedenza, era selezionato il menu a discesa Ordina per elenco prodotti disponibile con tutte le opzioni possibili nella pagina Categoria e la casella di controllo **Usa tutto**. [GitHub-32596](https://github.com/magento/magento2/issues/32596)
...
Per informazioni sull&#39;acquisto e il download, vedere [Dotdigital — Marketing Automation](https://commercemarketplace.adobe.com//dotdigital-dotdigital-magento2-os-package.html).
