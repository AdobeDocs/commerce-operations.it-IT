...
Per informazioni generali sulle patch di protezione, vedere [Introduzione alla versione](https://community.magento.com/t5/Magento-DevBlog/Introducing-the-New-Security-Patch-Release/ba-p/141287) della patch di protezione Nuovo. Per istruzioni sul download e l&#39;applicazione di patch di sicurezza (inclusa la patch 2.3.5-p2), vedere [Installazione rapida locale](../../../installation/composer.md). Le patch di sicurezza includono solo correzioni di bug di sicurezza, non i miglioramenti di sicurezza aggiuntivi inclusi nella patch completa.

## `AC-3022.patch` Applica continuare a offrire DHL come corriere marittimo

DHL ha introdotto la versione 6.2 dello schema e renderà obsoleta la versione 6.0 dello schema nel prossimo futuro. Adobe Systems Commerce 2.4.4 e versioni precedenti che supportano l&#39;integrazione DHL supportano solo la versione 6.0. I commercianti che implementano queste versioni dovrebbero richiedere `AC-3022.patch` al più presto di continuare a offrire DHL come corriere. Vedere l&#39;articolo [della Knowledge Base Applica una patch per continuare a offrire DHL come corriere](https://support.magento.com/hc/en-us/articles/7707818131597-Apply-a-patch-to-continue-offering-DHL-as-shipping-carrier) per informazioni sul download e l&#39;installazione della patch.
...
* Supporto iniziale per più impostazioni locali e contenuto localizzati sul negozio Venia <!-- PWA-295-->
...
* L&#39;inizializzazione dell&#39;helper delle immagini del catalogo ora utilizza il modello del `DataObject`prodotto anziché . _Correzione inviata da jmonteros422 in richiamare richiesta [29435](https://github.com/magento/magento2/pull/29435)_. [GitHub-1711](https://github.com/magento/adobe-stock-integration/issues/1711)

<!-- MC-37226-->

* Gli utenti amministratori possono ora salvare un campo Durata token cliente vuoto **(ore)** (Admin **Stores**  >  **Configurazioni**  >  **Servizi**  >  **OAuth**  >  **Scadenza** token di accesso). [GitHub-29502](https://github.com/magento/magento2/issues/29502)
...
* Il messaggio `Login failed` visualizzato dall&#39;applicazione quando un commerciante fa clic sulla **Licenza** per un&#39;immagine Adobe Stock salvata in precedenza e senza licenza non contiene più tag HTML. _Correzione inviata da yolouiese nella richiesta di pull [29398](https://github.com/magento/magento2/pull/29398)_. [GitHub-1684](https://github.com/magento/adobe-stock-integration/issues/1684)
...
* Le query SQL dirette sono state sostituite da Data Provider, che ha migliorato le prestazioni di estrazione. _Correzione inserita da Lukasz Bajsarowicz nel richiamare richiesta [29376](https://github.com/magento/magento2/pull/29376)_. [GitHub-29453](https://github.com/magento/magento2/issues/29453)
...
* I commercianti possono ora abilitare **Applica all&#39;importo** della spedizione nella scheda azione delle regole **di marketing** > **prezzo del** carrello > **aggiungere Nuovo regola** quando **viene applicato lo sconto sull&#39;importo fisso per l&#39;intero carrello**. [GitHub-24422](https://github.com/magento/magento2/issues/24422)

<!-- MC-23992-->

* Il applicazione non genera più un&#39;eccezione quando un acquirente tenta di annullare la disimpostazione del cookie di persistenza dopo aver avviato l&#39;estrazione e quindi essere passato alla home page del negozio. In precedenza, quando il acquirente faceva clic sul pulsante **Non sei?Collegamento** nella home page. L&#39;applicazione ha generato l&#39;eccezione: `The shipping address is missing. Set the address and try again`. [GitHub-24218](https://github.com/magento/magento2/issues/24218)
...
* Il codice che supporta la chiusura del mini carrello è stato modificato per rimuovere la `closeSidebar` funzione. L&#39;associazione di clic appropriata è stata aggiunta all&#39;elemento `[data-action="close"]` . _Correzione inserita da lumnn in richiamare richiesta [28906](https://github.com/magento/magento2/pull/28906)_. [GitHub-29161](https://github.com/magento/magento2/issues/29161)

<!-- ENGCOM-7585-->

* La nuova **Mostra &quot;Cancella carrello&quot; pulsante sull&#39;impostazione di configurazione della pagina** del carrello fornisce il controllo sulla visualizzazione di un **pulsante Cancella carrello** nella pagina di visualizzazione del carrello. Per impostazione predefinita, questa impostazione è disabilitata. _Correzione inviata da Pavlo Sydorenko nella richiesta di pull [27917](https://github.com/magento/magento2/pull/27917)_. [GitHub-28705](https://github.com/magento/magento2/issues/28705)
...
* Il applicazione ora ordina i prodotti più venduti come previsto. In precedenza, sia il conteggio dei prodotti che l&#39;impaginazione dei risultati di ordinamento non erano corretti. [GitHub-25955](https://github.com/magento/magento2/issues/25955)

<!-- ENGCOM-7292-->

* Gli acquirenti possono ora aprire la pagina dei dettagli di un prodotto facendo clic sul nome del prodotto nella barra laterale di confronto dei prodotti. _Correzione inviata da Eduard Chitoraga nella richiesta di pull [27451](https://github.com/magento/magento2/pull/27451)_. [GitHub-21101](https://github.com/magento/magento2/issues/21101)
...
* I contatti non vengono più sottoscritti di nuovo quando il loro `last_subscribed_at` valore è nullo.

* Gli errori di aggiornamento (risalenti alla versione 4.5.2) che interessavano le versioni precedenti sono stati risolti.

* È stato risolto un problema di regressione introdotto in 4.5.3 che riguardava l&#39;utilizzo di un metodo per ottenere lo stato di sottoscrittore durante la preparazione dell&#39;esportazione del sottoscrittore.

* La cifra totale per gli abbonati sincronizzati (visualizzata nei registri e sullo schermo) è ora calcolata correttamente.
...
* GraphQL ora utilizza solo un token di autorizzazione per recuperare un tipo di utente e il relativo ID. In precedenza, GraphQL utilizzava i cookie di un cliente attivo per recuperare queste informazioni quando il token di autorizzazione era vuoto. _Correzione inserita da Alexander Taranovsky nel richiamare richiesta [27373](https://github.com/magento/magento2/pull/27373)_. [GitHub-28040](https://github.com/magento/magento2/issues/28040)

<!-- ENGCOM-7839 32949-->

* Abbiamo aggiunto le [`createCustomerV2`](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-customer-v2.html) e [`updateCustomerV2`](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-customer-v2.html) mutazioni ai gestire account dei clienti. Queste nuove mutazioni richiedono oggetti di input diversi rispetto alle `createCustomer` mutazioni e `updateCustomer` . Per modificare l&#39;indirizzo e-mail di un cliente, utilizzare la nuova [`updateCustomerEmail`](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-customer-email.html) mutazione. _Correzione inviata da Michał Derlatka nella richiesta di pull [28888](https://github.com/magento/magento2/pull/28888)_. [GitHub-28570](https://github.com/magento/magento2/issues/28570)
...
* È stato aggiunto il supporto per le liste dei desideri in Magento Open Source. È possibile [aggiungere elementi](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-products-to-wishlist.html) a, [aggiornare elementi](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-products-in-wishlist.html) in e [rimuovere elementi](https://developer.adobe.com/commerce/webapi/graphql/mutations/remove-products-from-wishlist.html) da un elenco di desideri. _Correzione inviata da Eduard Chitoraga nella richiesta di pull [28205](https://github.com/magento/magento2/pull/28205)_. [GitHub-28551](https://github.com/magento/magento2/issues/28551)
...
* Sono stati aggiunti o aggiornati argomenti su Klarna GraphQL nel [metodo di pagamento di Klarna](https://developer.adobe.com/commerce/webapi/graphql/payment-methods/klarna.html) e[`createKlarnaPaymentsSession`](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-klarna-payments-session.html)
...
* Tutti gli errori di riferimento interrotti vengono ora registrati quando le distribuzioni sono solo in modalità sviluppatore. In precedenza, veniva registrato un errore anche per le distribuzioni in modalità produzione, che gonfiava i log degli errori. _Correzione presentata da Bartłomiej Szubert nel richiamare richiesta [28735](https://github.com/magento/magento2/pull/28735)_. [GitHub-26504](https://github.com/magento/magento2/issues/26504)
...
* Il applicazione visualizza ora i prodotti configurabili nella pagina della categoria come previsto dopo l&#39;aggiunta di un attributo di prodotto.

<!-- MC-33952-->

* I risultati dell&#39;Elasticsearch ora includono i valori corretti per le opzioni di attributo di ogni vista store. Se un `Dropdown` attributo OR `Multiple Select` ha un valore di opzione diverso nella visualizzazione store non predefinita rispetto alla visualizzazione store predefinita, Elasticsearch ora indicizza tale valore o restituisce il prodotto con quel valore nei risultati. In precedenza, non Elasticsearch indicizzato tale valore né restituito il prodotto con quel valore nei risultati.

<!-- MC-35013-->

* La ricerca per referenza di magazzino ora funziona come previsto nei ricerca avanzati con Elasticsearch. In precedenza, quando si tentava di ricerca da referenza di magazzino, il applicazione visualizzato questo messaggio di errore: `We can't find any items matching these search criteria. Modify your search`.

<!-- ENGCOM-7222-->

* Avanzate ricerca non consente più agli acquirenti di filtrare i prezzi negativi. _Correzione inviata da Rohan Hapani nella richiesta di pull [27359](https://github.com/magento/magento2/pull/27359)_. [GitHub-27358](https://github.com/magento/magento2/issues/27358)
...
* È ora possibile esportare `config.php` e impostare il codice predefinito da un sito Web per installare e configurare il applicazione su un secondo sito Web in una distribuzione multisito Web. In precedenza, il store e la vista predefiniti scomparivano dopo l&#39;esportazione e si verificavano errori sulla vetrina.
...
* L&#39;applicazione ora visualizza correttamente il widget Ordina per SKU nella pagina Categoria vetrina. In precedenza, il codice HTML per questo widget non veniva sottoposto a rendering e il applicazione non visualizzava l&#39;collegare **Carica un elenco di SKU** .
...
* Il **OK** pulsante sul mini carrello di conferma dell&#39;eliminazione del prodotto finestra a comparsa ora si comporta come previsto. _Correzione inviata da Tu Nguyen nel richiamare richiesta [28083](https://github.com/magento/magento2/pull/28083)_. [GitHub-27095](https://github.com/magento/magento2/issues/27095)

<!-- ENGCOM-7456-->

* Gli elementi della galleria prodotti non lampeggiano più durante il caricamento della pagina. _Correzione inviata da Mateusz Krzeszowiak nella richiesta di pull [27871](https://github.com/magento/magento2/pull/27871)_. [GitHub-28339](https://github.com/magento/magento2/issues/28339)
...
* L’etichetta di testo dei Termini e Condizioni ora può visualizzare correttamente stringhe di testo più lunghe. _Correzione presentata da Bartłomiej Szubert nel richiamare richiesta [29413](https://github.com/magento/magento2/pull/29413)_. [GitHub-24060](https://github.com/magento/magento2/issues/24060)

<!-- ENGCOM-7967-->

* Il titolo della pagina di errore dell&#39;ordine è stato riscritto per motivi di precisione. In precedenza, quando un acquirente annullava un ordine, il applicazione visualizzava una pagina con questo titolo: `We received your order!`. _Correzione inserita da Angelo Romano nel richiamare richiesta [29410](https://github.com/magento/magento2/pull/29410)_. [GitHub-29416](https://github.com/magento/magento2/issues/29416)

<!-- ENGCOM-7770-->

* Il numero totale di articoli annullati nella pagina di visualizzazione dell&#39;ordine annullato è ora correttamente identificato nella pagina di visualizzazione dell&#39;ordine annullato. In precedenza, questo campo era etichettato come **Totale dovuto**. _Correzione inviata da Madhu Rajawat nella richiesta di pull [27516](https://github.com/magento/magento2/pull/27516)_. [GitHub-26191](https://github.com/magento/magento2/issues/26191)
...
* L&#39;errore `Uncaught ReferenceError` non viene più visualizzato nella console di sviluppo quando si aggiunge un nuovo tag e si sposta il cursore del mouse su di esso. _Correzione presentata da Nazar Klovanych nel richiamare richiesta [29392](https://github.com/magento/magento2/pull/29392)_. [GitHub-1700](https://github.com/magento/magento2/issues/1700)
...
* Il riavvio di Varnish non genera più errori 503. _Correzione presentata da Ihor Sviziev in richiamare richiesta [28137](https://github.com/magento/magento2/pull/28137)_. [GitHub-24353](https://github.com/magento/magento2/issues/24353)

### Volta

<!-- MC-34674-->

* Il applicazione non salva più i numeri di scheda di credito quando la **casella di controllo Salva per un uso** successivo nella sezione di pagamento del workflow di pagamento non è selezionata.
...
Data Migration Tool consente di trasferire i dati store Magento 1.x esistenti a Magento 2.x. Questa interfaccia della riga di comando include funzioni di verifica, rilevamento dello stato di avanzamento, registrazione e test. Per istruzioni sull&#39;installazione, vedere [Installare lo strumento di migrazione dei dati](../../../tools/data-migration-tool/install.md). Esplorare o contribuire all&#39;[archivio di migrazione dei dati](https://github.com/magento/data-migration-tool).
