...
Il supporto di PHP 7.4 è stato rimosso da questa versione. Non è possibile eseguire Magenti Open Source 2.4.6 su PHP 7.4.
...
* Il Magento Open Source ora restituisce un messaggio informativo quando `addProductsToCart` la mutazione non riesce quando si aggiunge al carrello un prodotto con autorizzazioni insufficienti.
