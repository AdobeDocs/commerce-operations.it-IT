...
* `jquery-migrate` è stato rimosso dalle basi di codice Commerce e Magento Open Source. [GitHub-21406](https://github.com/magento/magento2/issues/21406) <!-- AC-1199 -->

* Aggiornato `jQuery/fileUpload` libreria alla versione 10.32. <!-- AC-2658-->

* I componenti del framework Zend (ZF1) che hanno raggiunto la fine del ciclo di vita sono stati rimossi dal codebase. Vedi [Modifiche non compatibili con le versioni precedenti in evidenza](https://developer-stage.adobe.com/commerce/php/development/backward-incompatible-changes/highlights/).<!-- AC-1512 -->
...
* `Types` che implementare più interfacce nel codice GraphQL possono ora essere separate da un `&` segno e `,` in conformità con le specifiche GraphQL `@doc`.
