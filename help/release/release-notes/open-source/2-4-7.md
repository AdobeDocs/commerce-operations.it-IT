...
* La Magento Open Source [integrazione](https://experienceleague.adobe.com/en/docs/commerce-admin/stores-sales/delivery/shipping-carriers/fedex) con FedEx è stata migrata dai servizi Web FedEx WSDL legacy alle più recenti API FedEx RESTful. FedEx Web Services Tracking, Address Validation, and Validate Postal Codes WSDLS sarà ritirato nel maggio 2024. <!-- AC-1470 -->
...
È possibile installare Magento Open Source 2.4.7 utilizzando [Composer](https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/composer.html).
