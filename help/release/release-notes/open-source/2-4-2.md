---
title: Magento Open Source 2.4.2 note sulla versione
description: Scopri su nuove funzioni, miglioramenti, correzioni di bug e problemi noti nella versione 2.4.2 Magento Open Source.
...
# Magento Open Source 2.4.2 note sulla versione

Il Magento Open Source 2.4.2 introduce miglioramenti a livello di prestazioni e sicurezza oltre a significativi miglioramenti della piattaforma. I miglioramenti della sicurezza includono l&#39;espansione del supporto per l&#39;attributo `SameSite` per tutti i cookie. Elasticsearch 7.9.x e Redis 6.x sono ora supportati.

Questa versione include oltre 280 nuove correzioni al codice di base e 35 miglioramenti della sicurezza. Include la risoluzione di quasi 290 problemi GitHub da parte dei nostri membri community. Questi contributi community vanno da una piccola pulizia del codice di base a miglioramenti significativi in GraphQL.

Tutte le problemi noti identificate nella versione 2.4.1 sono state corrette in questa versione.
...
I commercianti possono ora installare correzioni di sicurezza sensibili al fattore tempo senza applicare le centinaia di correzioni funzionali e miglioramenti forniti da una versione trimestrale completa (ad esempio, 2.4.1-p1). La patch 2.4.0.12 (pacchetto Composer 2.4.1-p1) è una patch di sicurezza che fornisce correzioni per le vulnerabilità identificate nella nostra precedente versione trimestrale, 2.4.1. Tutti gli hotfix applicati alla versione 2.4.1 sono inclusi in questa patch di sicurezza. (Un *hotfix* fornisce una correzione a una versione rilasciata che risolve un problema o un bug specifico.)

Per informazioni generali sulle patch di protezione, vedere [Introduzione alla versione](https://community.magento.com/t5/Magento-DevBlog/Introducing-the-New-Security-Patch-Release/ba-p/141287) della patch di protezione Nuovo. Per istruzioni su come scaricare e applicare le patch di sicurezza (inclusa la patch 2.4.1-p1), vedere [Installazione rapida locale](../../../installation/composer.md). Le patch di sicurezza includono solo correzioni di bug di sicurezza, non i miglioramenti di sicurezza aggiuntivi inclusi nella patch completa.
...
In questa versione la possibilità di configurare un&#39;installazione per l&#39;utilizzo di un database diviso è stata dichiarata obsoleta. I commercianti che attualmente utilizzano il database diviso dovrebbero iniziare a pianificare il ripristino o la migrazione a un singolo database o utilizzare un approccio alternativo. Per una panoramica di questo problema, vedere Deprecazione [della funzionalità di database diviso in Magento Open Source post](https://community.magento.com/t5/Magento-DevBlog/Deprecation-of-Split-Database-in-Magento-Commerce/ba-p/465187) DevBlog.  Vedere [Ripristino da un database diviso a un database](../../../configuration/storage/revert-split-database.md) singolo per istruzioni sulla migrazione.
...
Questa versione include Adobe Stock Integration v2.1.1.

### GraphQL

Questa versione aggiunge la copertura GraphQL per le seguenti funzionalità:
...
* È stata aggiunta la mutazione [`generateCustomerTokenAsAdmin`](https://developer.adobe.com/commerce/webapi/graphql/mutations/generate-customer-token-as-admin.html) e l&#39;oggetto `Customer` è stato aggiornato per supportare l&#39;assistenza per l&#39;acquisto remoto.
...
* Gli ID oggetto di tipo intero sono stati deprecati a favore degli attributi dell&#39;ID `uid` di tipo. <!-- MC-36346-->
...
* Il applicazione non genera più un errore quando si tenta di modificare `backend-frontname` utilizzando il contenitore dopo l&#39;installazione di `ssh` Magento Open Source. [GitHub-26762](https://github.com/magento/magento2/issues/26762)
...
* Il applicazione non visualizza più il **campo Regione** nel workflow di estrazione quando l&#39;impostazione **Consenti di scegliere lo stato se è facoltativo per Paese** è disabilitata. [GitHub-30747](https://github.com/magento/magento2/issues/30747)

<!-- ENGCOM-8442 -->

* Il applicazione ora aggiorna correttamente il subtotale degli articoli di un carrello quando un acquirente fa clic su **Aggiorna carrello** durante il check-out con più indirizzi. [GitHub-30408](https://github.com/magento/magento2/issues/30408)

<!-- ENGCOM-8283 -->

* Il applicazione non genera più un&#39;eccezione quando `config.xml` esistono nodi per metodi di pagamento attualmente non installati. In precedenza, il applicazione generava un&#39;eccezione durante il check-out. [GitHub-29555](https://github.com/magento/magento2/issues/29555)
...
* L&#39;endpoint `/V1/products/attributes/:attributeCode/options` REST ora supporta l&#39;aggiornamento di un&#39;opzione di attributo esistente.

<!-- MC-30626 ENGCOM-8475-->

* Il prezzo di un&#39;opzione personalizzata con un prezzo percentuale viene ora convertito, come previsto, nella valuta di base del store attivo nelle distribuzioni multi store. In precedenza, il prezzo di un&#39;opzione personalizzata con un prezzo percentuale veniva convertito in modo errato. [GitHub-26432](https://github.com/magento/magento2/issues/26432)
...
* Le griglie dei prodotti nelle **pagine Vendite** > **Ordini** e **Catalogo** > **Prodotti** ora elencano tutti i negozi pertinenti, non solo i store creati più di recente. [GitHub-29267](https://github.com/magento/magento2/issues/29267)

<!-- ENGCOM-6698 -->

* Prodotto archivio ora utilizza `store_id` quando disponibile per salvare i valori degli attributi per un prodotto esistente.  In precedenza, la classe archivio di prodotto sostituiva l&#39;ID store prodotto e assegnava sempre l&#39;ID store predefinito. [GitHub-29933](https://github.com/magento/magento2/issues/29933)

### Regola catalogo

<!-- MC-35065-->

* Le regole relative ai prezzi del catalogo ora funzionano come previsto con le opzioni personalizzate nelle pagine dei dettagli del prodotto. In precedenza, i prezzi dei prodotti su quella pagina non riflettevano le regole dei prezzi di catalogo applicabili. [GitHub-22856](https://github.com/magento/magento2/issues/22856)
...
* Il applicazione non copia più un cliente nell&#39;e-mail di conferma dell&#39;ordine quando `sales_email/order_comment/enabled` è disabilitato ed `sales_email/order_comment/copy_method` è impostato su `bcc`. [GitHub-29915](https://github.com/magento/magento2/issues/29915)
...
* Il applicazione ora rappresenta correttamente Arabo migliaia di simboli di raggruppamento e Arabo separatore decimale. In precedenza, Arabo simboli venivano tagliati. [GitHub-26676](https://github.com/magento/magento2/issues/26676)

<!-- MC-30631-->

* Il applicazione ora elimina le sessioni di database scadute dalla tabella del database `session` come previsto.
...
* Il raccoglitore di file di base ora rispetta .`AppState->emulateAreaCode()` [GitHub-39656](https://github.com/magento/magento2/issues/29656)

<!-- ENGCOM-8441 -->

* La nuova `BlockByIdentifier` classe supporta il recupero di un blocco di layout basato sull&#39;identificatore del blocco CMS. Di conseguenza, quando un blocco CMS viene rimosso dalla cache, il applicazione cancella anche la cache dei blocchi di layout. [GitHub-28309](https://github.com/magento/magento2/issues/28309)

<!-- ENGCOM-8385 -->

* Sono stati risolti i problemi relativi alla conversione degli argomenti numerici nelle code. In precedenza, quando si dichiarava un coda con argomenti numerici `type` nel `queue_topology.xml`, il valore dell&#39;argomento veniva lanciato alla stringa. [GitHub-29615](https://github.com/magento/magento2/issues/29615)
...
* La `category` query ora restituisce il percorso corretto di un&#39;immagine di categoria quando URL riscritture sono disabilitate.

<!-- MC-36648 8321-->

* La `resetPassword` mutazione restituisce ora un messaggio più informativo quando si verifica un errore. [GitHub-30179](https://github.com/magento/magento2/issues/30179)

<!-- MC-38078 ENGCOM-8504-->

* I risultati della query memorizzati nella cache vengono invalidati come previsto quando cambiano le posizioni dei `products` prodotti. [GitHub-30467](https://github.com/magento/magento2/issues/30467)
...
* Le query e `categoryList` ora considerano la disponibilità delle categorie in base alla configurazione delle autorizzazioni delle categorie e all&#39;ID `categories` categoria padre. [GitHub-29880](https://github.com/magento/magento2/issues/29880), [GitHub-30624](https://github.com/magento/magento2/issues/30624)

<!-- MC-37603-->

* La `updateProductsInWishList` mutazione ora convalida correttamente gli elementi della lista dei desideri. [GitHub-30467](https://github.com/magento/magento2/issues/30467)

<!-- ENGCOM-8430 PWA-1107-->

* Sono stati deprecati diversi attributi nella `ProductInterface` e `CategoryInterface` per impedirne l&#39;utilizzo nello storefront. [GitHub-30625](https://github.com/magento/magento2/issues/30625)
...
* La `products` query non restituisce più un errore quando il prodotto richiesto ha un prodotto correlato disabilitato. [GitHub-28892](https://github.com/magento/magento2/issues/28892)
...
* È stato aggiunto il supporto per la lettura `exif_image.png` o `exif-image.jpeg` la metadati. [GitHub-1449](https://github.com/magento/adobe-stock-integration/issues/1449)

<!-- ENGCOM-8296 -->

* CMYK colori delle immagini ora vengono resi correttamente. Quando l&#39;adattatore Imagick ora rileva che un&#39;immagine aperta ha uno spazio colore CMYK, lo spazio colore viene convertito in SRGB. In precedenza, queste immagini venivano sottoposte a rendering con colori invertiti. [GitHub-22375](https://github.com/magento/magento2/issues/22375)
...
* Ora puoi nascondere le immagini dei prodotti sulla vetrina durante l&#39;importazione.
...
* È stato aggiunto il metodo di escape URL mancante al widget del modulo modello di layout. [GitHub-30036](https://github.com/magento/magento2/issues/30036)

<!-- ENGCOM-8127 -->

* Il `\Magento\Framework\Filesystem\Io\File::read()` metodo è ora compatibile con `\Magento\Framework\Filesystem\Io\IoInterface::read()`. [GitHub-27866](https://github.com/magento/magento2/issues/27866)
...
* La pagina Admin **Stores**  >  **Configuration**  >  **Avanzate**  >  **System** è stata aggiornata per visualizzare il nome del prodotto corretto (Media Gallery). Sono state incluse piccole riprogettazioni dell&#39;interfaccia utente. [GitHub-1738](https://github.com/magento/adobe-stock-integration/issues/1738)

<!-- ENGCOM-8019 -->

* I collegamenti nella sezione Usato in delle descrizioni delle immagini di Media Gallery ora visualizzano una griglia che è stata filtrata dall&#39;immagine selezionata come previsto. In precedenza, la griglia visualizzata non aveva un titolo corretto e le voci dell&#39;elenco non erano accurate. [GitHub-1694](https://github.com/magento/adobe-stock-integration/issues/1694)

<!-- ENGCOM-8019 -->

* È ora possibile modificare correttamente più immagini in Media Gallery. In precedenza, non era possibile aggiungere tag a una seconda immagine dopo averli aggiunti a un&#39;immagine. [GitHub-1755](https://github.com/magento/adobe-stock-integration/issues/1755)
...
* Batch è ora supportata l&#39;elaborazione per la sincronizzazione di Media Gallery coda messaggi. [GitHub-1724](https://github.com/magento/adobe-stock-integration/issues/1724)

<!-- ENGCOM-8064 -->

* Il applicazione ora visualizza una pagina 404 come previsto quando si tenta di aprire Media Gallery quando **Enhanced Media Gallery** è disattivato. [GitHub-1760](https://github.com/magento/adobe-stock-integration/issues/1760)

<!-- ENGCOM-8072 -->

* `MediaGalleryMetadata` Ora ignora il lettore di segmenti se si verifica un&#39;eccezione e analizza e visualizza le metadati dell&#39;immagine come previsto. In precedenza, il metadati immagine era vuoto a causa di un&#39;eccezione del `exif_read_data` lettore di segmenti. [GitHub-1782](https://github.com/magento/adobe-stock-integration/issues/1782)

<!-- ENGCOM-8069 -->

* Cartella lunghezza del nome non impedisce più il caricamento di un&#39;immagine in Media Gallery. Galleria multimediale ora imposta la colonna percorso come tipo `text`. [GitHub-1778](https://github.com/magento/adobe-stock-integration/issues/1778)
...
* La verifica del percorso è stata aggiunta all&#39;plug-in dell&#39;autore del `Mediagallery` caricamento. In precedenza, convalida non riusciva e il applicazione non importava prodotti quando **l&#39;opzione Attiva raccolta multimediale precedente** era disattivata. [GitHub-30649](https://github.com/magento/magento2/issues/30649)

<!-- ENGCOM-8057 -->

* `Magento_Cms::media_gallery` Le risorse secondarie ACL sono state aggiunte e applicate affinché la nuova Media Gallery supporti le autorizzazioni configurate per le operazioni discrete seguenti:
...
* Implementato `ActionGroup` per passare alla pagina di checkout. [GitHub-29843](https://github.com/magento/magento2/issues/29843)
...
* Sono stati corretti i problemi relativi alla pagina skip nei test MFTF per la pagina CMS per Media Gallery. [GitHub-30164](https://github.com/magento/magento2/issues/30164)
...
* Gli acquirenti ospiti possono ora effettuare ordini PayPal quando **l&#39;assegnazione automatica al gruppo di clienti** è abilitata. Il pagamento viene elaborato sul gateway PayPal, l&#39;ordine viene creato in Magento e l&#39;acquirente visualizza la pagina di ringraziamento dell&#39;ordine. In precedenza, l&#39;ordine veniva elaborato correttamente sul gateway PayPal, ma l&#39;ordine non veniva creato in Magento Open Source. Il acquirente è stato invece reindirizzato alla pagina di revisione dell&#39;ordine, dove il applicazione visualizzato questo errore: `Failed address validation: %1" error`. [GitHub-25399](https://github.com/magento/magento2/issues/25399)
...
* Il applicazione non scarica più la cache delle categorie quando aggiungi o salvi un prodotto disabilitato in una categoria. In precedenza, l&#39;applicazione scaricava la cache per le categorie correlate nonostante lo stato del prodotto, che influiva sulle prestazioni del server.

<!-- MC-38518 -->

* Pagina tempo di caricamento per l&#39;aggiornamento dei quantità del prodotto nel carrello acquisti è migliorato. In precedenza, l&#39;applicazione eseguiva più query separate per ciascun prodotto nel carrello, il che aumentava il tempo di caricamento della pagina.

<!-- MC-39700 -->

* È stato aggiunto un `Magento_Bulk`  indicizzatore alla tabella MySQL, che ha migliorato le prestazioni delle operazioni in blocco.
...
* I campi che descrivono il metodo di consegna UPS in Admin **Store >** Configuration **>** **Sales >** **Delivery Methods** sono ora abilitati come previsto.
...
* I commercianti possono ora creare un&#39;etichetta di spedizione dalla pagina di spedizione per un ordine esistente che utilizza la spedizione FedEx quando JavaScript raggruppamento è abilitato. In precedenza, l&#39;applicazione generava un errore quando il commerciante faceva clic sull&#39;Crea **Shipping Etichetta** pulsante.

<!-- MC-36953-->

* Il collegamento di tracciamento della spedizione nell’e-mail di conferma della spedizione inviata ai clienti ora funziona come previsto. In precedenza, questo collegare restituito un errore 404.
...
* I valori di intestazione che includono gli URL vengono ora analizzati correttamente in `ApiFunctional TestFramework`. [GitHub-26425](https://github.com/magento/magento2/issues/26425)
...
* L&#39;endpoint PUT `V1/categories/:id` ora memorizza i dati necessari per la creazione di reindirizzamenti 301 per le chiavi URL di categoria quando viene fornito l&#39;attributo personalizzato `save_rewrites_history`. [GitHub-29174](https://github.com/magento/magento2/issues/29174), [GitHub-30240](https://github.com/magento/magento2/issues/30240)
...
* Ora gli amministratori possono accedere alla pagina Gestisci carrello dalla pagina del cliente Amministratore dopo che un cliente ha aggiunto un prodotto alla propria lista dei desideri dalla vetrina. In precedenza, l&#39;applicazione visualizzato il seguente errore quando l&#39;amministratore faceva clic sull&#39;pulsante **** Gestisci carrello: `An error has occurred. See error log for details`.
...
**Problema**: l&#39;applicazione crea un ordine nella Braintree come previsto quando un acquirente fa clic su **Paga con Venmo**, ma non crea l&#39;ordine nell&#39;amministratore. Vedi il [2.4.2 problema noto: Braintree pagamento Venmo non funziona](https://support.magento.com/hc/en-us/articles/360054662652/) Articolo della Knowledge Base.  <!-- BUNDLE-2894-->
...
È possibile installare il Magento Open Source 2.4.2 utilizzando [Compositore](../../../installation/composer.md).
