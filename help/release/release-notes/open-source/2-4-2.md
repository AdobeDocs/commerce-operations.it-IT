...
description: Scopri le nuove funzioni, i miglioramenti, le correzioni di bug e i problemi noti nella versione 2.4.2 di Magento Open Source.
recommendations: noCatalog
exl-id: 01e90bcb-d43c-4daa-9669-44e3370102af
last-update: 2026-04-28T00:00:00Z
source-git-commit: 1166b8fbfeef21a51ad6e4e695aed2b25006230e
workflow-type: tm+mt
source-wordcount: '14832'
ht-degree: 0%
...
* [Braintree](https://experienceleague.adobe.com/it/docs/commerce-admin/stores-sales/payments/braintree)
...
* In questa versione la possibilità di configurare un&#39;installazione per l&#39;utilizzo di un database diviso è stata dichiarata obsoleta. Per istruzioni sulla migrazione, vedere [Ripristino da un database diviso a un singolo database](../../../configuration/storage/revert-split-database.md).
...
* L&#39;applicazione non genera più un errore quando si tenta di modificare `backend-frontname` utilizzando il contenitore `ssh` dopo l&#39;installazione di Magento Open Source. [GitHub-26762](https://github.com/magento/magento2/issues/26762)
...
* Magento Open Source ha migliorato le prestazioni della cache eliminando lo scaricamento dei tag più volte per istanza di indicizzatore. [GitHub-29890](https://github.com/magento/magento2/issues/29890)
...
* Gli acquirenti ospiti possono ora effettuare ordini PayPal quando **l&#39;assegnazione automatica al gruppo di clienti** è abilitata. Il pagamento viene elaborato sul gateway PayPal, l&#39;ordine viene creato in Magento e l&#39;acquirente visualizza la pagina di ringraziamento dell&#39;ordine. In precedenza, l&#39;ordine era stato elaborato correttamente sul gateway PayPal, ma l&#39;ordine non era stato creato in Magento Open Source. L&#39;acquirente è stato invece reindirizzato alla pagina di revisione dell&#39;ordine, in cui l&#39;applicazione ha visualizzato l&#39;errore: `Failed address validation: %1" error`. [GitHub-25399](https://github.com/magento/magento2/issues/25399)
...
* Elasticsearch non genera più un errore di modificatore sconosciuto quando un acquirente cerca un sinonimo di ricerca. In precedenza, l’escape non presentava un simbolo di barra di escape nelle espressioni regolari, causando un errore irreversibile.
...
**Problema**: l&#39;applicazione crea un ordine in Braintree come previsto quando un acquirente fa clic su **Paga con Venmo**, ma non crea l&#39;ordine nell&#39;amministratore. Vedi il [2.4.2 problema noto: il pagamento di Braintree Venmo non funziona](https://support.magento.com/hc/en-us/articles/360054662652/) Articolo della Knowledge Base.  <!-- BUNDLE-2894-->
...
È possibile installare Magento Open Source 2.4.2 utilizzando [Composer](../../../installation/composer.md).
