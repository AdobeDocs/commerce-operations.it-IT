...
>[!NOTE]
>
>In genere, ai nomi dei pacchetti delle versioni di sicurezza viene aggiunto -p1. Tuttavia, non abbiamo potuto evitare di deviare da queste convenzioni di denominazione con 2.3.5, che a sua volta ha avuto un effetto a catena temporaneo sui successivi nomi dei pacchetti di sicurezza. In particolare, la versione completa 2.3.5 è 2.3.5-p1. Gli aggiornamenti della sicurezza che verranno rilasciati quando i GA 2.4.0 saranno 2.3.5-p2. Speriamo di tornare alle consuete convenzioni di denominazione nelle versioni future.
...
* **Migrazione delle dipendenze da Zend Framework al [progetto](https://getlaminas.org/about/foundation)** Laminas per riflettere la transizione di Zend Framework al progetto Laminas della Linux Foundation. Zend Framework è obsoleto. Vedi la [migrazione del framework Zend al progetto](https://community.magento.com/t5/Magento-DevBlog/Migration-of-Zend-Framework-to-the-Laminas-Project/ba-p/443251) Laminas DevBlog post.

* **La scomposizione dei controller** consente agli sviluppatori di estensioni di implementare ActionInterface direttamente senza classi di &quot;supertipo di livello&quot;. Consulta il post [Decomposizione dei controller](https://community.magento.com/t5/Magento-DevBlog/Decomposition-of-Magento-Controllers/ba-p/430883) DevBlog. _Miglioramento iniziato da Vinai Kopp nel richiamare richiesta [16268](https://github.com/magento/magento2/pull/16268) e finalizzato da Lukasz Bajsarowicz nel richiamare richiesta [26778](https://github.com/magento/magento2/pull/26778)_. [GitHub-9582](https://github.com/magento/magento2/issues/9582)

* **Rimozione dell&#39;integrazione di base del codice di protezione dalle frodi Signifyd**. Questa funzionalità di base non è più supportata. I commercianti devono migrare all&#39;estensione [](https://marketplace.magento.com/signifyd-module-connect.html) Signifyd Fraud &amp; Chargeback Protection disponibile sul Commerce Marketplace.

* Il **modulo Braintree principale è stato rimosso dalla codebase**. Il modulo Braintree pagamenti fornisce ora la stessa serie di funzioni. Vedi [Braintree pagamenti](https://marketplace.magento.com/paypal-module-braintree.html).
...
* **Supporto per ricerca di parole parziali per Elasticsearch (nuovo motore di ricerca predefinito).** Elasticsearch ora supporta l&#39;utilizzo di parole parziali in termini ricerca per i nomi di prodotto e SKU quando si utilizza Quick ricerca. Questa funzionalità è stata supportata dal motore di ricerca MySQL, che è stato deprecato e sostituito da Elasticsearch in questa versione.
...
Per un elenco delle versioni di PWA Studio e delle relative versioni compatibili, vedere [Compatibilità](https://developer.adobe.com/commerce/pwa-studio/integrations/adobe-commerce/version-compatibility/) . Per informazioni sui miglioramenti e le correzioni di bug, consulta [PWA Studio versioni](https://github.com/magento/pwa-studio/releases).
...
* `db-ssl-verify`  non genera più un errore di indice non definito durante un&#39;installazione `ddev` . _Correzione inserita da Daniel Ruf nel richiamare richiesta [26763](https://github.com/magento/magento2/pull/26763)_. [GitHub-26762](https://github.com/magento/magento2/issues/26762)

<!-- ENGCOM-6247-->

* Le dipendenze del compositore sono state aggiornate alla scadenza della chiave implementare Redis, migliorando le prestazioni di Redis. _Correzione presentata da toxix in richiamare richiesta [25488](https://github.com/magento/magento2/pull/25488)_. [GitHub-25487](https://github.com/magento/magento2/issues/25487)

### Integrazione di Adobe Stock

<!-- ENGCOM-6507-->

* Sono stati aggiunti stili CSS alla visualizzazione delle immagini Adobe Stock per supportare l’evidenziazione dell’immagine selezionata.  _Correzione presentata da Serhiy Zhovnir nel richiamare richiesta [25864](https://github.com/magento/magento2/pull/25864)_. [GitHub-761](https://github.com/magento/adobe-stock-integration/issues/761)

<!-- ENGCOM-7021-->

* La navigazione tra Adobe Stock immagini di anteprima non viene più attivata spostando il cursore del campo di input tramite i tasti freccia.  _Correzione inviata da Adarsh Manickam nella richiesta di pull [27138](https://github.com/magento/magento2/pull/27138)_. [GitHub-973](https://github.com/magento/adobe-stock-integration/issues/973)
...
* I modelli e-mail (**Admin** > **Marketing** > **Communications** > **Email Templates**) possono ora essere visualizzati in anteprima dall&#39;amministratore quando JavaScript minimizzazione è abilitata. In precedenza, quando si tentava di visualizzare l&#39;anteprima di un modello di e-mail, la finestra popup del Anteprima e-mail era vuota. [GitHub-25068](https://github.com/magento/magento2/issues/25068)

<!-- ENGCOM-6433-->

* Gli amministratori possono ora accedere all&#39;amministratore come previsto dopo la creazione di un account di amministratore con privilegi limitati. In precedenza, l’amministratore non era accessibile. Gli utenti con queste autorizzazioni sono stati invece reindirizzati alla vetrina con un errore 404. _Correzione inviata da Eden Duong nella richiesta di pull [25909](https://github.com/magento/magento2/pull/25909)_. [GitHub-25881](https://github.com/magento/magento2/issues/25881)
...
* La pagina di revisione dell&#39;ordine nel workflow di checkout ora viene caricata correttamente per un ordine che viene spedito a più indirizzi quando è abilitata l&#39;impostazione Termini e condizioni con l&#39;impostazione **Applicato manualmente** . In precedenza, la pagina Revisione non passava convalida e il applicazione visualizzato un errore 404.
...
* La griglia dei coupon non utilizzati nel workflow Crea nuovo carrello regola è stata disattivata. _Correzione inserita da Eden Duong nel richiamare richiesta [24471](https://github.com/magento/magento2/pull/24471)_. [GitHub-24468](https://github.com/magento/magento2/issues/24468)

<!-- ENGCOM-6615-->

* La modifica della via fatturazione non modifica più l&#39;indirizzo di spedizione di un cliente quando è stato selezionato un unico indirizzo sia per l&#39;indirizzo fatturazione che per quello di spedizione. _Correzione inviata da Yurii Tvardyi nella richiesta di pull [26279](https://github.com/magento/magento2/pull/26279)_. [GitHub-26276](https://github.com/magento/magento2/issues/26276)
...
* È stata migliorata la logica di aggiornamento del layout personalizzato della pagina CMS. L&#39;applicazione ora applica specifiche modifiche al layout da `cms_page_view_selectable_home_somechanges.xml`. _Correzione presentata da Sergiy Vasiutynskyi in richiamare richiesta [27131](https://github.com/magento/magento2/pull/27131)_. [GitHub-26758](https://github.com/magento/magento2/issues/26758)
...
* La visualizzazione Amministratore di un carrello clienti ora mostra tutti i prodotti aggiunti al carrello da più siti web in una distribuzione multisito. In precedenza, quando un cliente aggiungeva un prodotto al carrello da un sito Web non predefinito, il prodotto non veniva visualizzato nella lineare Amministratore quando **Condividi account** cliente è impostato su **Globale**.

<!-- ENGCOM-7036-->

* La convalida ora funziona come previsto per il **campo Data di nascita** quando si modifica un cliente dall&#39;amministratore. In precedenza, il applicazione non teneva conto delle impostazioni internazionali del utente e per alcune date di nascita veniva visualizzato questo errore: `The Date of Birth should not be greater than today`.   _Correzione inserita da Sergiy Vasiutynskyi in richiamare richiesta [27149](https://github.com/magento/magento2/pull/27149)_. [GitHub-27027](https://github.com/magento/magento2/issues/27027)

<!-- ENGCOM-6208-->

* Il campo e-mail non è più necessario quando si effettua un ordine dall&#39;amministratore.  _Correzione inserita da solwininfotech in richiamare richiesta [24479](https://github.com/magento/magento2/pull/24479)_. [GitHub-22251](https://github.com/magento/magento2/issues/22251)

<!-- ENGCOM-6667-->

* Il applicazione ora visualizza solo i prodotti che il cliente ha inserito nel carrello quando il carrello viene visualizzato dall&#39;amministratore. In precedenza, il carrello di un cliente visualizzava tutti i prodotti del catalogo quando venivano visualizzati dall&#39;amministratore. _Correzione inviata da Ravinder in richiamare richiesta [26489](https://github.com/magento/magento2/pull/26489)_. [GitHub-26437](https://github.com/magento/magento2/issues/26437)

<!-- ENGCOM-6423-->

* La dashboard di Il mio account ora visualizza correttamente i valori dell&#39;indirizzo e-mail nella visualizzazione mobile. _Correzione inviata da Eden Duong in richiamare richiesta [25942](https://github.com/magento/magento2/pull/25942)_. [GitHub-25935](https://github.com/magento/magento2/issues/25935)
...
* Il tag `date` in `/module-sales/view/frontend/templates/order/order_date.phtml` è stato corretto in `span`. In precedenza, l&#39;applicazione aveva registrato un errore nel file `exception.log` quando si faceva clic su **Visualizza ordine** nella pagina **Account personale** > **Ordini personali**. _Correzione inserita da Andrii Chorniy nel richiamare richiesta [25895](https://github.com/magento/magento2/pull/25895)_. [GitHub-13269](https://github.com/magento/magento2/issues/13269), [GitHub-25738](https://github.com/magento/magento2/issues/25738)

<!-- ENGCOM-6316-->

* Il modulo mixin JavaScript è stato rifattorizzato per migliorare il caricamento e la applicazione dei mixin per i moduli avanzati in bundle. In precedenza, il applicazione non caricava o applicava mixin per i moduli avanzati in bundle.  _Correzione inviata da Mateusz Krzeszowiak nella richiesta di pull [25587](https://github.com/magento/magento2/pull/25587)_. [GitHub-25586](https://github.com/magento/magento2/issues/25586)
...
* Il risultato `getVersion` (`ProductMetadata::getVersion`) è ora memorizzato nella cache, il che migliora le prestazioni del metodo `ProductMetadata::getVersion`.  _Correzione inserita da Lukasz Lewandowski nel richiamare richiesta [26001](https://github.com/magento/magento2/pull/26001)_. [GitHub-24025](https://github.com/magento/magento2/issues/24025)
...
* Facendo clic su **Invio** dopo aver denominato una nuova cartella in Media Gallery vengono salvate tutte le modifiche apportate. In precedenza, facendo clic su **Invio** invece di utilizzare il mouse per selezionare **OK** tutte le modifiche andavano perse.  _Correzione presentata da Sergiy Vasiutynskyi nel richiamare richiesta [27029](https://github.com/magento/magento2/pull/27029)_. [GitHub-26847](https://github.com/magento/magento2/issues/26847)
...
* L’implementazione di base della protezione contro le frodi Signifyd non è più supportata. Gli esercenti devono migrare all&#39;estensione [Signifyd Fraud &amp; Chargeback Protection](https://marketplace.magento.com/signifyd-module-connect.html) disponibile su Commerce Marketplace.
...
* Il metodo di pagamento PayPal Pro ora funziona come previsto nei Effetto cromatura 80 browser. Questo metodo di pagamento in precedenza richiamava un endpoint di callback che doveva accesso alla sessione del cliente, accesso che la nuova funzionalità predefinita Effetto cromatura cookie SameSite non consentiva. [GitHub-26840](https://github.com/magento/magento2/issues/26840)

<!-- MC-31292-->

* Ora puoi utilizzare correttamente PayPal Express per pagare un ordine quando il carrello di pagamento permanente è stato abilitato e l&#39;impostazione **Cancella persistenza alla disconnessione** è impostata su **no**. In precedenza, il applicazione ti reindirizzava alla pagina di accesso.

<!-- ENGCOM-6383-->

* I pagamenti da PayPal Express e Web Payments Pro ora passano allo stato previsto una volta iniziata l&#39;elaborazione `Processing` . In precedenza, PayPal pagamenti Web Payments Pro rimanevano nello stato di `Pending` pagamento lineare quando le `Processing` informazioni di pagamento si trovavano nello stato. _Correzione inserita da azambon in richiamare richiesta [25876](https://github.com/magento/magento2/pull/25876)_. [GitHub-25659](https://github.com/magento/magento2/issues/25659)
...
* Il layout del modulo di modifica delle informazioni sull&#39;indirizzo dell&#39;ordine cliente è stato modificato per corrispondere alle convenzioni libreria del modulo di amministrazione. _Correzione inviata da Alexey Rakitin nel richiamare richiesta [25699](https://github.com/magento/magento2/pull/25699)_. [GitHub-19805](https://github.com/magento/magento2/issues/19805)

<!-- ENGCOM-6007-->

* Le caselle di controllo nella sezione Prodotti della **pagina Catalogo** > **Categorie** ora funzionano come previsto.  _Correzione presentata da Denis Kopylov nel richiamare richiesta [22990](https://github.com/magento/magento2/pull/22990)_. [GitHub-22988](https://github.com/magento/magento2/issues/22988)
...
* Le fatture PDF ora acquisiscono la data di acquisto corretta quando vengono create in una lingua GB. _Correzione inserita da Eden Duong nel richiamare richiesta [26701](https://github.com/magento/magento2/pull/26701)_. [GitHub-26675](https://github.com/magento/magento2/issues/26675)
...
* Aggiunta di `<magentoCron>` a più test per attivare la reindicizzazione parziale. Questa modifica consente di risolvere i problemi che hanno creato falsi negativi nei test funzionali relativi a `Magento_Bundle`, `CatalogImportExport`, `CatalogInventory`, `CatalogRule`, `Backend`, `Braintree` e `Captcha`. _Correzione presentata da Lukasz Bajsarowicz in richiamare richieste 27322, 27323](https://github.com/magento/magento2/pull/27323), [27321](https://github.com/magento/magento2/pull/27321)_. [](https://github.com/magento/magento2/pull/27322)[ [GitHub-27320](https://github.com/magento/magento2/issues/27320)

<!-- ENGCOM-6844-->

* Tutti gli usi scorretti di `<amOnPage>` sono stati sostituiti con un appropriato `<actionGroup>` per la disconnessione dell&#39;amministratore, ove applicabile nei test. _Correzione inviata da Lukasz Bajsarowicz nella richiesta di pull 116 nei partner dell&#39;archivio privato Magento2ee_. [GitHub-26331](https://github.com/magento/magento2/issues/26331)
...
* Il conteggio numerico dei segnaposto e il conteggio dei segnaposto JavaScript codice sono ora uguali. In precedenza, il codice JavaScript presupponeva lo 0%, mentre il conteggio dei segnaposto numerici iniziava con %1.  _Correzione inviata da korostii nella richiesta di pull [25359](https://github.com/magento/magento2/pull/25359)_. [GitHub-25243](https://github.com/magento/magento2/issues/25243)
...
* La colonna `customer_note` della tabella `quote` utilizza ora il tipo `text` come previsto. In precedenza utilizzava il tipo `varchar(255)`. _Correzione inviata da Ravi Chandra nella richiesta di pull [26160](https://github.com/magento/magento2/pull/26160)_. [GitHub-26155](https://github.com/magento/magento2/issues/26155)
...
* Il risultato del GET `/V1/orders/items/{id}` ora include un elemento attributo di estensione che include i dati dei messaggi regalo. _Correzione inviata da Laura Folco nella richiesta di pull [25946](https://github.com/magento/magento2/pull/25946)_. [GitHub-19093](https://github.com/magento/magento2/issues/19093)
...
[Code Migration Toolkit](https://github.com/magento/code-migration) consente di trasferire le estensioni e le personalizzazioni dell&#39;archivio di Magento 1.x esistenti nel Magento 2.x. L&#39;interfaccia della riga di comando include script per la conversione di moduli e layout Magento 1.x.
