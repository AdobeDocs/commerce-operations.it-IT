---
title: Note sulla versione di Adobe Commerce 2.4.6-p4
description: Scopri le correzioni per i problemi di sicurezza nella versione 2.4.6-p4 di Adobe Commerce.
...
# Note sulla versione di Adobe Commerce 2.4.6-p4

Adobe Commerce 2.4.6-p4 è una versione di sicurezza che fornisce cinque correzioni di sicurezza che migliorano la distribuzione di Adobe Commerce 2.4.6 o Magento Open Source 2.4.6. Fornisce correzioni per le vulnerabilità identificate nelle versioni precedenti.
