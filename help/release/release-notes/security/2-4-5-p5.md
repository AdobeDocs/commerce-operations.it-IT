---
title: Note sulla versione di Adobe Commerce 2.4.5-p5
description: Scopri le correzioni per i problemi di sicurezza nella versione 2.4.5-p5 di Adobe Commerce.
...
# Note sulla versione di Adobe Commerce 2.4.5-p5

Adobe Commerce 2.4.5-p5 è una versione di sicurezza che fornisce dieci correzioni di sicurezza che migliorano la tua implementazione di Adobe Commerce 2.4.5 o Magento Open Source 2.4.5. Fornisce correzioni per le vulnerabilità identificate nelle versioni precedenti.
