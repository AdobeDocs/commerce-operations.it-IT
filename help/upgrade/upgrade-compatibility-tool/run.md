...
Per ulteriori informazioni su [, consulta questa ](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/upgrade/upgrade-compatibility-tool-overview.html?lang=en)esercitazione video:02 (06[!DNL Upgrade Compatibility Tool]).
