...
È consigliabile seguire alcuni principi guida fondamentali durante l’utilizzo di un progetto e-commerce.
...
Nelle organizzazioni più piccole, i dirigenti a livello C tendono a essere coinvolti in modo massiccio o almeno molto vicini al progetto di trasformazione. Tuttavia, quando iniziamo a guardare a commercianti più grandi, è naturale che il coinvolgimento dei dirigenti diminuisca man mano che le dimensioni dell&#39;azienda aumentano. Per questo motivo, è fondamentale che queste parti interessate siano coinvolte e informate in tutto il progetto per garantire che l’acquisto e il supporto rimangano intatti.
...
Responsabile in ultima analisi dei risultati del progetto e responsabile della sicurezza dell&#39;autorità di spesa e delle risorse per il progetto.

- Campione vocale e visibile
- Legittima e conferisce credibilità agli obiettivi e agli obiettivi strategici
- È il punto di escalation per i cambiamenti e le questioni al di fuori delle tolleranze concordate?
- Aiuta con il coinvolgimento delle parti interessate, se necessario

#### Dirigenti aziendali

Responsabile di garantire che il progetto si concentri sul raggiungimento dei suoi obiettivi e aderisca a un approccio basato sui costi, fornendo un prodotto che raggiunga i benefici previsti e facendo analisi costi-benefici per l&#39;azienda.
...
- Garantisce che sia specificato il risultato desiderato
...
Rappresenta gli interessi di coloro che progettano, sviluppano, agevolano, procurano e attuano il prodotto. Questo ruolo è responsabile della qualità dei prodotti consegnati dai fornitori ed è responsabile dell&#39;integrità tecnica del progetto.

- Valuta e conferma la fattibilità dell&#39;approccio
- Garantisce che le proposte per la progettazione e lo sviluppo del prodotto siano realistiche
- Consiglia nella selezione dei metodi di progettazione, sviluppo e accettazione
- Garantisce che le procedure di qualità siano utilizzate correttamente, in modo che i prodotti rispettino i requisiti

#### Testa del digitale

Copre gli interessi principali delle parti interessate dell&#39;impresa, degli utenti tecnici, degli utenti finali e dei fornitori.

- Garantisce che le persone giuste siano coinvolte nell&#39;ispezione di qualità nei punti corretti dello sviluppo del prodotto
- Garantisce che il personale sia adeguatamente formato nei metodi di qualità
- Verifica che i metodi di qualità siano seguiti correttamente
- Garantisce che le azioni di controllo della qualità siano trattate correttamente
- Revisioni regolari per garantire lo sviluppo di una soluzione accettabile
- Assicurati che la portata del progetto non cambi senza un adeguato preavviso
- Verifica il funzionamento delle comunicazioni interne ed esterne
- Garantisce l&#39;applicazione delle norme applicabili
- Si accerta che siano osservate le esigenze di interessi particolari (ad esempio, la sicurezza)

Responsabilità in materia di assicurazione delle imprese:

- Aiuta a sviluppare il business case e il piano di revisione dei benefici
- Verifica la conformità agli standard aziendali
- Verifica il business case rispetto a eventi esterni
- Verifica che il business case sia rispettato in tutto il progetto
- Verifica che il progetto rimanga allineato alla strategia aziendale e continua a fornire un buon rapporto qualità-prezzo Responsabilità di assicurazione degli utenti
- Garantisce che le specifiche delle esigenze degli utenti siano accurate, complete e inequivocabili
- Valuta se la soluzione soddisfa le esigenze degli utenti e procede verso tale obiettivo
- Consiglia sull&#39;impatto dei potenziali cambiamenti dal punto di vista degli utenti
- Garantisce che le attività di qualità relative ai prodotti in tutte le fasi siano adeguatamente rappresentate dall&#39;utente
- Garantisce che le procedure di controllo della qualità siano utilizzate correttamente per garantire che i prodotti soddisfino i requisiti degli utenti

Responsabilità di assicurazione del fornitore:

- Rivede le descrizioni dei prodotti (funzionalità e funzionalità) e si allinea alla consegna
- Consiglia di selezionare la strategia, la progettazione e i metodi di sviluppo
- Garantisce che tutti i fornitori e gli standard operativi definiti per il progetto siano rispettati e utilizzati in modo efficace
- Consiglia i potenziali cambiamenti e il loro impatto sulla correttezza, completezza e integrità dei prodotti rispetto alla loro descrizione del prodotto dal punto di vista del fornitore
- Valuta se le procedure di controllo della qualità sono utilizzate correttamente, in modo che i prodotti soddisfino i requisiti.

#### Gestore di e-commerce

Ha l&#39;autorità di eseguire le operazioni quotidiane con la responsabilità primaria di garantire che il risultato produca i prodotti richiesti entro le tolleranze specificate di tempo, costo, qualità, portata, rischio e benefici.

La gestione efficace di un sito di e-commerce richiede al team di gestione del progetto di possedere e applicare conoscenze in diversi settori:

- Gestione dei progetti
- Conoscenza del settore aziendale e industriale specifica del prodotto e della piattaforma
- Conoscenza tecnologica richiesta dal prodotto
- Capacità interpersonali e di comunicazione
- Il quadro di riferimento per la gestione dei progetti è costituito da cinque gruppi di attività chiave:
...
- Le attività del ciclo di vita del progetto sono generalmente sequenziali, mentre le attività di gestione dei progetti vengono eseguite contemporaneamente, perché le attività di gestione dei progetti possono sovrapporsi e ripetersi secondo il calendario a seconda dei rischi (ad esempio, le attività di controllo possono portare a una pianificazione della revisione degli obiettivi o del piano in seguito a modifiche).
